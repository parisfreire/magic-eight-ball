define(['dart_sdk', 'packages/intl/date_symbols', 'packages/intl/src/plural_rules', 'packages/intl/number_symbols', 'packages/intl/number_symbols_data'], function(dart_sdk, date_symbols, plural_rules, number_symbols, number_symbols_data) {
  ...
  src__intl_helpers.UninitializedLocaleData$ = dart.generic(F => {
    ...
    dart.setMethodSignature(UninitializedLocaleData, () => ({
      ...
      lookupMessage: dart.fnType(core.String, [core.String, core.String, core.String, core.List, core.String], {ifAbsent: dart.fnType(dart.dynamic, [core.String, core.List])}),

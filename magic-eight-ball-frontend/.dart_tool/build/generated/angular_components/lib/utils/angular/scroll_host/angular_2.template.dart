...
void initReflector() {
  ...
  _ngRef.registerFactory(WindowScrollHost, (_i1.DomService p0, _i2.NgZone p1, _i3.GestureListenerFactory p2, _i4.Window p3) => new WindowScrollHost(p0, p1, p2, p3));
  _ngRef.registerDependencies(WindowScrollHost, const [
    const [_i1.DomService],
    const [_i2.NgZone],
    const [_i3.GestureListenerFactory],
    const [_i4.Window]
  ]);
  _ref0.initReflector();
  _ref1.initReflector();

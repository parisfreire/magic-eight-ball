...
class ViewMaterialPopupComponent0 extends AppView<import2.MaterialPopupComponent> {
  ...
  void detectHostChanges(bool firstCheck) {
    ...
    if (import9.checkBinding(_expr_0, currVal_0)) {
      setAttr(rootEl, 'pane-id', currVal_0);
      _expr_0 = currVal_0;
    }
  }
}
...
class _ViewMaterialPopupComponent1 extends AppView<import2.MaterialPopupComponent> {
  ...
  ComponentRef<import2.MaterialPopupComponent> build() {
    ...
    addShimC(_el_3);
    final _text_4 = import8.Text('\n          ');
    _el_3.append(_text_4);
    final _el_5 = createDivAndAppend(doc, _el_3);
    _el_5.className = 'material-popup-content content';
    addShimC(_el_5);
    final _text_6 = import8.Text('\n              ');
    _el_5.append(_text_6);
    final _el_7 = createAndAppend(doc, 'header', _el_5);
    addShimE(_el_7);
    final _text_8 = import8.Text('\n                  ');
    ...
    final _el_11 = createDivAndAppend(doc, _el_5);
    _el_11.className = 'main';
    addShimC(_el_11);
    final _text_12 = import8.Text('\n                  ');
    _el_11.append(_text_12);
    project(_el_11, 1);
    final _text_13 = import8.Text('\n              ');
    _el_11.append(_text_13);
    final _text_14 = import8.Text('\n              ');
    _el_5.append(_text_14);
    final _el_15 = createAndAppend(doc, 'footer', _el_5);
    addShimE(_el_15);
    final _text_16 = import8.Text('\n                  ');
    _el_15.append(_text_16);
    project(_el_15, 2);
    final _text_17 = import8.Text('\n              ');
    _el_15.append(_text_17);
    final _text_18 = import8.Text('\n          ');
    _el_5.append(_text_18);
    final _text_19 = import8.Text('\n      ');
    _el_3.append(_text_19);
    final _text_20 = import8.Text('\n  ');
    _el_1.append(_text_20);
    final _text_21 = import8.Text('\n');
...
class _ViewMaterialPopupComponentHost0 extends AppView<import2.MaterialPopupComponent> {
  ...
  ComponentRef<import2.MaterialPopupComponent> build() {
    ...
    _MaterialPopupComponent_0_8 = (import10.isDevMode
        ? import12.debugInjectorWrap(import2.MaterialPopupComponent, () {
            return import2.MaterialPopupComponent(this.injectorGet(import13.PopupHierarchy, viewData.parentIndex, null), this.injectorGet(import2.MaterialPopupComponent, viewData.parentIndex, null), null, this.injectorGet(import14.NgZone, viewData.parentIndex), this.injectorGet(import15.OverlayService, viewData.parentIndex), this.injectorGet(import16.ZIndexer, viewData.parentIndex), this.injectorGet(const import17.OpaqueToken<List<import19.RelativePosition>>('defaultPopupPositions'), viewData.parentIndex), this.injectorGet(const import17.OpaqueToken<dynamic>('overlayRepositionLoop'), viewData.parentIndex), this.injectorGet(import20.PopupSizeProvider, viewData.parentIndex, null), _compView_0.ref, _appEl_0, ElementRef(rootEl));
          })
        : import2.MaterialPopupComponent(this.injectorGet(import13.PopupHierarchy, viewData.parentIndex, null), this.injectorGet(import2.MaterialPopupComponent, viewData.parentIndex, null), null, this.injectorGet(import14.NgZone, viewData.parentIndex), this.injectorGet(import15.OverlayService, viewData.parentIndex), this.injectorGet(import16.ZIndexer, viewData.parentIndex), this.injectorGet(const import17.OpaqueToken<List<import19.RelativePosition>>('defaultPopupPositions'), viewData.parentIndex), this.injectorGet(const import17.OpaqueToken<dynamic>('overlayRepositionLoop'), viewData.parentIndex), this.injectorGet(import20.PopupSizeProvider, viewData.parentIndex, null), _compView_0.ref, _appEl_0, ElementRef(rootEl)));
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((((identical(token, import2.MaterialPopupComponent) || identical(token, import22.DeferredContentAware)) || identical(token, import23.DropdownHandle)) && (0 == nodeIndex))) {
      return _MaterialPopupComponent_0_8;
    }
    if ((identical(token, import13.PopupHierarchy) && (0 == nodeIndex))) {
      return _PopupHierarchy_0_11;
    }
    if ((identical(token, import24.PopupRef) && (0 == nodeIndex))) {

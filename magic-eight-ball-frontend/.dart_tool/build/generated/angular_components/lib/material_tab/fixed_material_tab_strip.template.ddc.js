define(['dart_sdk', 'packages/angular_components/material_tab/fixed_material_tab_strip.scss.css.shim', 'packages/angular/src/core/linker/view_type', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/material_tab/fixed_material_tab_strip', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/focus/focus_list', 'packages/angular/src/core/zone/ng_zone', 'packages/angular_components/focus/focus_list.template', 'packages/angular_components/focus/focus', 'packages/angular_components/material_tab/tab_button.template', 'packages/angular_components/focus/focus_item', 'packages/angular_components/focus/focus_item.template', 'packages/angular_components/material_tab/tab_button', 'packages/angular/angular.template', 'packages/angular_components/annotations/rtl_annotation.template', 'packages/angular_components/material_tab/tab_change_event.template'], function(dart_sdk, fixed_material_tab_strip$46scss$46css, view_type, change_detection, fixed_material_tab_strip, modules, focus_list, ng_zone, focus_list$, focus, tab_button, focus_item, focus_item$, tab_button$, angular, rtl_annotation, tab_change_event) {
  ...
  material_tab__fixed_material_tab_strip$46template._ViewFixedMaterialTabStripComponent1 = class _ViewFixedMaterialTabStripComponent1 extends src__core__linker__app_view.AppView$(material_tab__fixed_material_tab_strip.FixedMaterialTabStripComponent) {
    ...
    detectChangesInternal() {
      ...
      if (dart.test(src__core__linker__app_view_utils.checkBinding(this[_expr_1], currVal_1))) {
        this.setAttr(this[_el_0], "aria-selected", currVal_1);
        this[_expr_1] = currVal_1;
      }
  ...
  }, '{"version":3,"sourceRoot":"","sources":["fixed_material_tab_strip.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MA8CoB,uFAAqC;YAAG,EAAS,iEAAM;;;;;;;;;;;;;;;AAoBvE,UAAM,UAAU,WAAM;AACtB,UAA0B,mBAAmB,iBAAY,CAAC,OAAO;AACjE,UAAI,MAAc,aAAQ;AAC1B,iBAAK,GAAG,8CAAkB,CAAC,GAAG,EAAE,gBAAgB;AAChD,iBAAK,UAAU,GAAG;AAClB,qBAAU,CAAC,WAAK,EAAE,aAAa;AAC/B,qBAAU,CAAC,WAAK,EAAE,QAAQ;AAC1B,mBAAQ,CAAC,WAAK;AACd,mCAAuB,OAAG,uDAA8B,CAAE,UAAS,qCAAS,IACtE,AAAS,iCAAiB,uCAAU,mDAAkB,EAAE,kBAC/C,wCAA2B,wCAAC,eAAU,YAAY,CAAU,8CAAM,EAAE,aAAQ,YAAY,IAAG,+CAEpG,wCAA2B,wCAAC,eAAU,YAAY,CAAU,8CAAM,EAAE,aAAQ,YAAY,IAAG;AACjG,iBAAK,GAAG,8CAAkB,CAAC,GAAG,EAAE,WAAK;AACrC,iBAAK,UAAU,GAAG;AAClB,mBAAQ,CAAC,WAAK;AACd,UAAM,YAAY,qDAAyB;AAC3C,iBAAK,SAAO,CAAC,SAAS;AACtB,oBAAQ,OAAG,mDAAa,CAAC,GAAG,GAAG,MAAM,SAAS;AAC9C,UAAY,uBAAmB,+CAAW,CAAC,cAAQ,EAAE,gKAA2C;AAChG,sBAAU,OAAG,yCAAa,CAAC,cAAQ,EAAE,gBAAgB;AACrD,eAAI,CAAC,uDAAU;IACjB;;AAIE,UAAM,OAAO,QAAG;AAChB,UAAM,YAAY,IAAI,UAAU;AAChC,oBAAI,AAAS,8CAAY,CAAC,aAAO,EAAE,SAAS,IAAG;AAC7C,wBAAU,QAAQ,GAAG,SAAS;AAC9B,qBAAO,GAAG,SAAS;;AAErB,qBAAK,8CAAqB,eAAe,GAAE;AACzC,wBAAU,UAAU;;AAEtB,oBAAQ,2BAA2B;AACnC,qBAAK,8CAAqB,eAAe,GAAE;AACzC,sBAAI,sCAAgC,GAAE;AACpC,uCAAuB,SAAS,UAAU,GAAG,cAAQ,eAAe,qHAAC,QAAC,UAA+C,IAC5G,6BAAC,UAAU,oBAAmB;AAEvC,gDAAgC,GAAG;;;AAGvC,mCAAuB,kBAAkB,CAAC,MAAM,WAAK;AACrD,UAAM,YAAY,IAAI,sBAAsB;AAC5C,oBAAI,AAAS,8CAAY,CAAC,aAAO,EAAE,SAAS,IAAG;AAC7C,mBAAK,MAAM,cAAY,CAAC,aAAa,SAAS;AAC9C,qBAAO,GAAG,SAAS;;IAEvB;;AAIE,4BAAQ;;AACR,mCAAuB,SAAS,YAAY;IAC9C;;wGAhEoC,UAA2B,EAAE,WAAe;IAT7D,WAAK;IACO,6BAAuB;IACnC,WAAK;IACV,cAAQ;IACjB,sCAAgC,GAAG;IAC1B,gBAAU;IACpB,aAAO;IACP,aAAO;AAEyE,mHAAM,qCAAgB,UAAU,EAAE,2CAAI,UAAU,EAAE,WAAW,EAAE,8DAAuB,UAAU;AAClL,eAAM,2BAAG,AAAQ,aAAQ,gBAAc,CAAC;AACxC,eAAM,UAAU,GAAG,qEAAsC,UAAU;AACnE,6GAAW;gBAAX,iGAAW,GAAK,AAAS,8CAAY,iBAAiB,CAAE,UAAS,qCAAS,IAAG,4EAA4E,MAAO,2CAAiB,SAAS,EAAE,uFAAqC;AACjO,2BAAkB,CAAC,iGAAW;EAChC;;;;;;;;;;;;;;;;;;;;MAN2B,iGAAW;;;;;2GAoEoD,UAA2B,EAAE,WAAe;AACtI,eAAO,yFAAmC,CAAC,UAAU,EAAE,WAAW;EACpE;;;;;;;;;AAiBI,uBAAW,OAAG,+DAAgC,CAAC,MAAM;AACrD,iBAAK,GAAG,iBAAW,OAAO;AAC1B,iBAAK,UAAU,GAAG;AAClB,qBAAU,CAAC,WAAK,EAAE,aAAa;AAC/B,qBAAU,CAAC,WAAK,EAAE,QAAQ;AAC1B,mBAAQ,yBAAC,WAAK;AACd,mCAAuB,OAAG,uDAA+B,KAAC,wCAA2B,yBAAC,WAAK,GAAE;AAC7F,mCAAuB,OAAG,+CAA2B,CAAC,WAAK;AAC3D,8BAAkB,GAAG,6BAAuB,SAAS;AACrD,uBAAW,OAAO,CAAC,6BAAuB,EAAE;AAC5C,iBAAK,mBAAiB,CAAC,WAAW,kBAAa,2CAAC,6BAAuB,SAAS;AAChF,UAAM,iBAAiB,6BAAuB,QAAQ,OAAO,CAAC,kBAAa,6BAAC,oCAAmB;AAC/F,eAAI,CAAC,CAAC,WAAK,GAAG,CAAC,cAAc;IAC/B;wBAG4B,KAAa,EAAE,SAAa,EAAE,cAAsB;AAC9E,UAAK,AAAU,KAAK,KAAW,yCAAa,IAAM,MAAK,SAAS,EAAI;AAClE,cAAO,yBAAkB;;AAE3B,YAAO,eAAc;IACvB;;AAIE,UAAM,OAAO,QAAG;AAChB,UAAK,aAAc,YAAY,KAAI;AACnC,UAAM,YAAY,AAAS,sCAAU,WAAM,WAAM,QAAC;AAClD,UAAM,iBAAiB,AAAS,sCAAU,cAAS,WAAM,QAAC;AAC1D,UAAI,UAAU,EAAE;AACd,QAAC,6BAAuB,KAAK,GAAG;;AAElC,UAAM,YAAY,cAAc;AAChC,oBAAI,AAAS,8CAAY,CAAC,aAAO,EAAE,SAAS,IAAG;AAC7C,qCAAuB,MAAM,GAAG,SAAS;AACzC,qBAAO,GAAG,SAAS;;AAErB,UAAM,YAAa,IAAI,eAAe,IAAI,SAAS;AACnD,oBAAI,AAAS,8CAAY,CAAC,aAAO,EAAE,SAAS,IAAG;AAC7C,qCAAuB,SAAS,GAAG,SAAS;AAC5C,qBAAO,GAAG,SAAS;;AAErB,qBAAM,8CAAqB,eAAe,KAAI,UAAU,EAAG;AACzD,qCAAuB,SAAS;;AAElC,UAAM,YAAY,IAAI,MAAM,CAAC,SAAS;AACtC,oBAAI,AAAS,8CAAY,CAAC,aAAO,EAAE,SAAS,IAAG;AAC7C,oBAAO,CAAC,WAAK,EAAE,MAAM,SAAS;AAC9B,qBAAO,GAAG,SAAS;;AAErB,UAAM,YAAY,IAAI,UAAU,CAAC,SAAS;AAC1C,oBAAI,AAAS,8CAAY,CAAC,aAAO,EAAE,SAAS,IAAG;AAC7C,oBAAO,CAAC,WAAK,EAAE,iBAAiB,SAAS;AACzC,qBAAO,GAAG,SAAS;;AAErB,mCAAuB,kBAAkB,CAAC,iBAAW,EAAE,WAAK;AAC5D,uBAAW,kBAAkB,CAAC,UAAU;AACxC,uBAAW,cAAc;IAC3B;;AAIE,MAAS,sCAAU,wFAAsC,eAAU,mCAAkC,GAAG;IAC1G;;AAIE,+BAAW;;IACb;0BAEyB,MAAM;AAC7B,UAAM,YAAY,AAAS,sCAAU,WAAM,WAAM,QAAC;AAClD,cAAG,SAAS,CAAC,SAAS;IACxB;;yGA9EqC,UAA2B,EAAE,WAAe;IATjE,WAAK;IACY,iBAAW;IACZ,6BAAuB;IAC3B,6BAAuB;IACvB,wBAAkB;IAC1C,aAAO;IACP,aAAO;IACJ,aAAO;IACT,aAAO;AACyE,oHAAM,qCAAgB,SAAS,EAAE,0CAAC,aAAc,MAAM,SAAS,QAAO,UAAU,EAAE,WAAW,EAAE,8DAAuB,YAAY;AACrN,sBAAa,GAAG,qFAAmC,YAAY;EACjE;;;;;;;;;;;;;;;;;;;;;;;2GA+E0F,UAA2B,EAAE,WAAe;AACtI,eAAO,0FAAoC,CAAC,UAAU,EAAE,WAAW;EACrE;;MAEoB,2FAAyC;YAAG;;;;;;;;AAQ5D,uBAAW,OAAG,yFAAmC,CAAC,MAAM;AACxD,iBAAM,GAAG,iBAAW,OAAO;AAC3B,+CAAmC,GAAI,UAAS,qCAAS,IACnD,AAAS,iCAAiB,wEAAS,oFAA8B,EAAE,kBAC1D,yEAAsC,CAAC,iBAAW,IAAI,mBAAE,gBAAgB,CAAC,qCAAM,2CAA6B,CAAC,YAAU,aAAQ,YAAY,EAAE,wDAEtJ,yEAAsC,CAAC,iBAAW,IAAI,mBAAE,gBAAgB,CAAC,qCAAM,2CAA6B,CAAC,YAAU,aAAQ,YAAY,EAAE;AACnJ,uBAAW,OAAO,CAAC,yCAAmC,EAAE,qBAAgB;AACxE,gBAAK,CAAC,WAAM;AACZ,iBAAO,oDAAY,CAAC,GAAG,MAAM,WAAM,EAAE,yCAAmC;IAC1E;;AAIE,UAAK,UAAU;AACf,UAAI,OAAO,EAAE;AACX,yBAAW,gBAAgB;;AAE7B,uBAAW,cAAc;IAC3B;;AAIE,+BAAW;;IACb;;6GA3ByC,UAA2B,EAAE,WAAe;IAFjD,iBAAW;IACR,yCAAmC;AACe,wHAAM,qCAAgB,KAAK,EAAE,2CAAI,UAAU,EAAE,WAAW,EAAE,8DAAuB,YAAY;EAAC;;;;;;;;;;;;;+GA8BzF,UAA2B,EAAE,WAAe;AAC1I,eAAO,8FAAwC,CAAC,UAAU,EAAE,WAAW;EACzE;;MAE+D,0FAAwC;YAAG,gBAAM,wDAAgB,CAAC,sBAAsB,oKAA+C;;;;;AAEpM,YAAO,2FAAwC;IACjD;;;MAEI,0DAAQ;YAAG;;;;;AAEb,kBAAI,0DAAQ,GAAE;AACZ;;AAEF,iEAAW;AAEX,IAAO,oCAAiB,CAAC,oFAA8B,EAAE,yFAAuC;AAChG,IAAM,gCAAa;AACnB,IAAM,oDAAa;AACnB,IAAM,0CAAa;AACnB,IAAM,0CAAa;AACnB,IAAM,iDAAa;AACnB,IAAM,uDAAa;EACrB","file":"fixed_material_tab_strip.template.ddc.js"}');
  // Exports:
  return {

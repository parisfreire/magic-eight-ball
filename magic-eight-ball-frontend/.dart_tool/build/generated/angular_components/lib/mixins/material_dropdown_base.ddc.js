define(['dart_sdk', 'packages/angular_components/laminate/enums/alignment', 'packages/angular_components/content/deferred_content_aware', 'packages/angular_components/src/laminate/popup/popup_hierarchy'], function(dart_sdk, alignment, deferred_content_aware, popup_hierarchy) {
  'use strict';
  ...
  mixins__material_dropdown_base.MaterialDropdownBase[dart.implements] = () => [mixins__material_dropdown_base.DropdownHandle, content__deferred_content_aware.DeferredContentAware, src__laminate__popup__popup_ref.PopupRef];
  ...
  dart.setGetterSignature(mixins__material_dropdown_base.MaterialDropdownBase, () => ({
    ...
    visibleStream: async.Stream$(core.bool),
    visible: core.bool,

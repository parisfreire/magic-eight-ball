define(['dart_sdk', 'packages/angular/angular.template', 'packages/angular_components/content/deferred_content_aware.template', 'packages/angular_components/laminate/enums/alignment.template', 'packages/angular_components/laminate/popup/popup.template'], function(dart_sdk, angular, deferred_content_aware, alignment, popup) {
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_dropdown_base.template.dart"],"names":[],"mappings":";;;;;;;;;;;;MAiBI,kDAAQ;YAAG;;;;;AAEb,kBAAI,kDAAQ,GAAE;AACZ;;AAEF,yDAAW;AAEX,IAAM,gCAAa;AACnB,IAAM,wDAAa;AACnB,IAAM,mDAAa;AACnB,IAAM,+CAAa;EACrB","file":"material_dropdown_base.template.ddc.js"}');
  // Exports:
  return {

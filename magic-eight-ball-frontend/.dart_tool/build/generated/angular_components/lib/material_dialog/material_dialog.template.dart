...
import '../laminate/components/modal/modal.dart' as import17;
...
class _ViewMaterialDialogComponentHost0 extends AppView<import2.MaterialDialogComponent> {
  ...
  ComponentRef<import2.MaterialDialogComponent> build() {
    ...
    _MaterialDialogComponent_0_5 = (import12.isDevMode
        ? import15.debugInjectorWrap(import2.MaterialDialogComponent, () {
            return import2.MaterialDialogComponent(rootEl, this.injectorGet(import16.DomService, viewData.parentIndex), _compView_0.ref, this.injectorGet(import17.ModalComponent, viewData.parentIndex, null));
          })
        : import2.MaterialDialogComponent(rootEl, this.injectorGet(import16.DomService, viewData.parentIndex), _compView_0.ref, this.injectorGet(import17.ModalComponent, viewData.parentIndex, null)));

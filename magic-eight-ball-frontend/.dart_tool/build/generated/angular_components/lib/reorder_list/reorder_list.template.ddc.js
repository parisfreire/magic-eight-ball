define(['dart_sdk', 'packages/angular_components/reorder_list/reorder_list.scss.css.shim', 'packages/angular/src/core/linker/view_type', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/reorder_list/reorder_list', 'packages/angular/src/bootstrap/modules', 'packages/angular/src/core/zone/ng_zone', 'packages/angular/src/core/change_detection/directive_change_detector', 'packages/angular/angular.template', 'packages/angular_components/reorder_list/reorder_events.template', 'packages/angular_components/utils/disposer/disposer.template', 'packages/angular_components/utils/keyboard/keyboard.template'], function(dart_sdk, reorder_list$46scss$46css, view_type, change_detection, reorder_list, modules, ng_zone, directive_change_detector, angular, reorder_events, disposer, keyboard) {
  ...
  reorder_list__reorder_list$46template.ReorderItemDirectiveNgCd = class ReorderItemDirectiveNgCd extends src__core__change_detection__directive_change_detector.DirectiveChangeDetector {
    ...
    detectHostChanges(view, el) {
      ...
      if (dart.test(src__core__linker__app_view_utils.checkBinding(this[_expr_0], currVal_0))) {
        this.setAttr(el, "draggable", currVal_0);
        this[_expr_0] = currVal_0;
      }
    }
  };
  ...
  }, '{"version":3,"sourceRoot":"","sources":["reorder_list.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MAmCoB,iEAA2B;YAAG,EAAS,qDAAM;;;;;;;;;;AAiB7D,UAAM,UAAU,WAAM;AACtB,UAA0B,mBAAmB,iBAAY,CAAC,OAAO;AACjE,UAAM,UAAU,aAAY,CAAC;AAC7B,sBAAgB,SAAO,CAAC,OAAO;AAC/B,kBAAO,CAAC,gBAAgB,EAAE;AAC1B,UAAI,MAAc,aAAQ;AAC1B,iBAAK,GAAG,8CAAkB,CAAC,GAAG,EAAE,gBAAgB;AAChD,iBAAK,UAAU,GAAG;AAClB,mBAAQ,CAAC,WAAK;AACd,kBAAO,CAAC,WAAK,EAAE;AACf,cAAG,YAAY,GAAG,WAAK;AACvB,eAAI,CAAC,uDAAU;IACjB;;AAIE,UAAM,OAAO,QAAG;AAChB,UAAW,YAAY,WAAC,IAAI,gBAAgB;AAC5C,oBAAI,AAAQ,8CAAY,CAAC,aAAO,EAAE,SAAS,IAAG;AAC5C,wBAAW,CAAC,WAAK,EAAE,UAAU,SAAS;AACtC,qBAAO,GAAG,SAAS;;IAEvB;sBAEuB,UAAe;AACpC,UAAM,YAAY,QAAG,cAAc;AACnC,oBAAI,AAAQ,8CAAY,CAAC,aAAO,EAAE,SAAS,IAAG;AAC5C,4BAAe,CAAC,WAAM,EAAE,YAAY,SAAS;AAC7C,qBAAO,GAAG,SAAS;;AAErB,UAAM,YAAY,QAAG,YAAY;AACjC,oBAAI,AAAQ,8CAAY,CAAC,aAAO,EAAE,SAAS,IAAG;AAC5C,4BAAe,CAAC,WAAM,EAAE,eAAe,SAAS;AAChD,qBAAO,GAAG,SAAS;;IAEvB;;kFA5C0B,UAA2B,EAAE,WAAe;IALnD,WAAK;IACnB,aAAO;IACP,aAAO;IACP,aAAO;AAE8D,6FAAM,qCAAgB,UAAU,EAAE,2CAAI,UAAU,EAAE,WAAW,EAAE,8DAAuB,YAAY;AAC1K,eAAM,2BAAG,AAAQ,aAAQ,gBAAc,CAAC;AACxC,eAAM,UAAU,GAAG,+CAA4B,UAAU;AACzD,mBAAU,CAAC,WAAM,EAAE,QAAQ,+CAA4B,SAAS;AAChE,uFAAW;gBAAX,2EAAW,GAAK,AAAQ,8CAAY,iBAAiB,CAAE,UAAQ,qCAAS,IAAG,gEAAgE,MAAO,2CAAiB,SAAS,EAAE,iEAA2B;AACzM,2BAAkB,CAAC,2EAAW;EAChC;;;;;;;;;;;;;;;;MAP2B,2EAAW;;;;;qFAgDgC,UAA2B,EAAE,WAAe;AAClH,eAAO,mEAAyB,CAAC,UAAU,EAAE,WAAW;EAC1D;;MAEoB,qEAA+B;YAAG;;;;;;;AAQlD,uBAAW,OAAG,mEAAyB,CAAC,MAAM;AAC9C,iBAAM,GAAG,iBAAW,OAAO;AAC3B,qCAAyB,GAAI,UAAQ,qCAAS,IACxC,AAAS,iCAAiB,kDAAS,8DAAoB,EAAE,kBAChD,mDAA4B,wCAAC,gBAAgB,CAAU,8CAAM,EAAE,aAAQ,YAAY,0CAE5F,mDAA4B,wCAAC,gBAAgB,CAAU,8CAAM,EAAE,aAAQ,YAAY;AACzF,qCAAyB,MAAM,GAAG;AAClC,uBAAW,OAAO,CAAC,+BAAyB,EAAE,qBAAgB;AAC9D,gBAAK,CAAC,WAAM;AACZ,iBAAO,0CAAY,CAAC,GAAG,MAAM,WAAM,EAAE,+BAAyB;IAChE;wBAG4B,KAAa,EAAE,SAAa,EAAE,cAAsB;AAC9E,UAAK,AAAU,KAAK,KAAU,8DAAoB,IAAM,MAAK,SAAS,EAAI;AACxE,cAAO,gCAAyB;;AAElC,YAAO,eAAc;IACvB;;AAIE,UAAK,aAAc,YAAY,KAAI;AACnC,uBAAW,kBAAkB,CAAC,UAAU;AACxC,uBAAW,cAAc;IAC3B;;AAIE,+BAAW;;AACX,qCAAyB,YAAY;IACvC;;uFAnC+B,UAA2B,EAAE,WAAe;IAFjD,iBAAW;IACR,+BAAyB;AACyB,kGAAM,qCAAgB,KAAK,EAAE,2CAAI,UAAU,EAAE,WAAW,EAAE,8DAAuB,YAAY;EAAC;;;;;;;;;;;;;;yFAsCnG,UAA2B,EAAE,WAAe;AACtH,eAAO,wEAA8B,CAAC,UAAU,EAAE,WAAW;EAC/D;;MAEqD,oEAA8B;YAAG,gBAAM,8CAAgB,CAAC,gBAAgB,oIAAqC;;;;;AAEhK,YAAO,qEAA8B;IACvC;;;IAGqC;;;;;;sBAGZ,IAAqB,EAAE,EAAkB;AAC9D,UAAM,YAAY,aAAQ,cAAc;AACxC,oBAAI,AAAQ,8CAAY,CAAC,aAAO,EAAE,SAAS,IAAG;AAC5C,oBAAO,CAAC,EAAE,EAAE,aAAa,SAAS;AAClC,qBAAO,GAAG,SAAS;;IAEvB;;iFAPyB,QAAa;IADlC,aAAO;IACmB,eAAQ,GAAR,QAAQ;;EAAC;;;;;;;;;MAUrC,8CAAQ;YAAG;;;;;AAEb,kBAAI,8CAAQ,GAAE;AACZ;;AAEF,qDAAW;AAEX,IAAO,oCAAiB,CAAC,8DAAoB,EAAE,mEAA6B;AAC5E,IAAM,gCAAa;AACnB,IAAM,qDAAa;AACnB,IAAM,kDAAa;AACnB,IAAM,kDAAa;AACnB,IAAM,qDAAa;EACrB","file":"reorder_list.template.ddc.js"}');
  // Exports:
  return {

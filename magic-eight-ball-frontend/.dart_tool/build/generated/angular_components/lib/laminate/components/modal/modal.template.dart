...
class ViewModalComponent0 extends AppView<import1.ModalComponent> {
  ...
  void detectHostChanges(bool firstCheck) {
    ...
    if (import8.checkBinding(_expr_1, currVal_1)) {
      setAttr(rootEl, 'pane-id', currVal_1);
      _expr_1 = currVal_1;
    }
  }
}
...
class _ViewModalComponentHost0 extends AppView<import1.ModalComponent> {
  ...
  ComponentRef<import1.ModalComponent> build() {
    ...
    _ModalComponent_0_5 = (import9.isDevMode
        ? import12.debugInjectorWrap(import1.ModalComponent, () {
            return import1.ModalComponent(this.injectorGet(import13.OverlayService, viewData.parentIndex), rootEl, this.injectorGet(import14.NgZone, viewData.parentIndex), this.injectorGet(import1.Modal, viewData.parentIndex, null), this.injectorGet(import1.GlobalModalStack, viewData.parentIndex, null));
          })
        : import1.ModalComponent(this.injectorGet(import13.OverlayService, viewData.parentIndex), rootEl, this.injectorGet(import14.NgZone, viewData.parentIndex), this.injectorGet(import1.Modal, viewData.parentIndex, null), this.injectorGet(import1.GlobalModalStack, viewData.parentIndex, null)));
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((((identical(token, import1.ModalComponent) || identical(token, import15.DeferredContentAware)) || identical(token, import1.Modal)) && (0 == nodeIndex))) {

...
import 'package:angular_components/material_datepicker/comparison_option.template.dart' as _ref10;
import 'package:angular_components/material_datepicker/config.template.dart' as _ref11;
import 'package:angular_components/material_datepicker/date_range_editor.template.dart' as _ref12;
...
import 'package:angular_components/model/date/date_formatter.template.dart' as _ref21;
import 'package:angular_components/model/observable/observable.template.dart' as _ref22;
import 'package:angular_components/utils/angular/css/css.template.dart' as _ref23;
import 'package:angular_components/utils/browser/dom_service/dom_service.template.dart' as _ref24;
import 'package:angular_components/utils/disposer/disposer.template.dart' as _ref25;
...
import 'next_prev_buttons.template.dart' as import39;
import 'next_prev_buttons.dart' as import40;
import '../focus/focus_trap.template.dart' as import41;
import '../focus/focus_trap.dart' as import42;
import 'date_range_editor.template.dart' as import43;
import 'date_range_editor.dart' as import44;
import '../material_button/material_button.template.dart' as import45;
...
import 'config.dart' as import50;
...
class ViewMaterialDateRangePickerComponent0 extends AppView<import2.MaterialDateRangePickerComponent> {
  ...
  ComponentRef<import2.MaterialDateRangePickerComponent> build() {
    ...
    _KeyboardOnlyFocusIndicatorDirective_0_6 = (import17.isDevMode
        ? import20.debugInjectorWrap(import5.KeyboardOnlyFocusIndicatorDirective, () {
            return import5.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.injectorGet(import21.DomService, viewData.parentIndex));
          })
        : import5.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.injectorGet(import21.DomService, viewData.parentIndex)));
    _PopupSourceDirective_0_7 = (import17.isDevMode
        ? import20.debugInjectorWrap(import6.PopupSourceDirective, () {
            return import6.PopupSourceDirective(parentView.injectorGet(import22.DomPopupSourceFactory, viewData.parentIndex), _el_0, parentView.injectorGet(import23.ReferenceDirective, viewData.parentIndex, null), parentView.injectorGet(import24.Focusable, viewData.parentIndex, null), null);
          })
        : import6.PopupSourceDirective(parentView.injectorGet(import22.DomPopupSourceFactory, viewData.parentIndex), _el_0, parentView.injectorGet(import23.ReferenceDirective, viewData.parentIndex, null), parentView.injectorGet(import24.Focusable, viewData.parentIndex, null), null));
    ...
    addShimC(_el_2);
    final _el_3 = createSpanAndAppend(doc, _el_2);
    ...
    _MaterialPopupComponent_7_8 = (import17.isDevMode
        ? import20.debugInjectorWrap(import12.MaterialPopupComponent, () {
            return import12.MaterialPopupComponent(parentView.injectorGet(import26.PopupHierarchy, viewData.parentIndex, null), parentView.injectorGet(import12.MaterialPopupComponent, viewData.parentIndex, null), null, parentView.injectorGet(import27.NgZone, viewData.parentIndex), parentView.injectorGet(import28.OverlayService, viewData.parentIndex), parentView.injectorGet(import29.ZIndexer, viewData.parentIndex), parentView.injectorGet(const import30.OpaqueToken<List<import32.RelativePosition>>('defaultPopupPositions'), viewData.parentIndex), parentView.injectorGet(const import30.OpaqueToken<dynamic>('overlayRepositionLoop'), viewData.parentIndex), parentView.injectorGet(import33.PopupSizeProvider, viewData.parentIndex, null), _compView_7.ref, _appEl_7, ElementRef(_el_7));
          })
        : import12.MaterialPopupComponent(parentView.injectorGet(import26.PopupHierarchy, viewData.parentIndex, null), parentView.injectorGet(import12.MaterialPopupComponent, viewData.parentIndex, null), null, parentView.injectorGet(import27.NgZone, viewData.parentIndex), parentView.injectorGet(import28.OverlayService, viewData.parentIndex), parentView.injectorGet(import29.ZIndexer, viewData.parentIndex), parentView.injectorGet(const import30.OpaqueToken<List<import32.RelativePosition>>('defaultPopupPositions'), viewData.parentIndex), parentView.injectorGet(const import30.OpaqueToken<dynamic>('overlayRepositionLoop'), viewData.parentIndex), parentView.injectorGet(import33.PopupSizeProvider, viewData.parentIndex, null), _compView_7.ref, _appEl_7, ElementRef(_el_7)));
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    ...
    if ((((identical(token, import12.MaterialPopupComponent) || identical(token, import36.DeferredContentAware)) || identical(token, import37.DropdownHandle)) && ((7 <= nodeIndex) && (nodeIndex <= 8)))) {
      return _MaterialPopupComponent_7_8;
    }
    if ((identical(token, import26.PopupHierarchy) && ((7 <= nodeIndex) && (nodeIndex <= 8)))) {
      return _PopupHierarchy_7_11;
    }
    if ((identical(token, import38.PopupRef) && ((7 <= nodeIndex) && (nodeIndex <= 8)))) {
...
class _ViewMaterialDateRangePickerComponent2 extends AppView<import2.MaterialDateRangePickerComponent> {
  ...
  import39.ViewNextPrevComponent0 _compView_0;
  import40.NextPrevComponent _NextPrevComponent_0_5;
  bool _expr_0;
  ...
  @override
  ComponentRef<import2.MaterialDateRangePickerComponent> build() {
    _compView_0 = import39.ViewNextPrevComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    _el_0.className = 'next-prev-buttons';
    addShimC(_el_0);
    _NextPrevComponent_0_5 = import40.NextPrevComponent(_compView_0.ref);
...
class _ViewMaterialDateRangePickerComponent4 extends AppView<import2.MaterialDateRangePickerComponent> {
  import3.Element _el_0;
  import41.ViewFocusTrapComponent0 _compView_0;
  import42.FocusTrapComponent _FocusTrapComponent_0_5;
  import3.Element _el_2;
  import43.ViewDateRangeEditorComponent0 _compView_2;
  import44.DateRangeEditorComponent _DateRangeEditorComponent_2_5;
  import3.DivElement _el_3;
  import3.Element _el_6;
  import45.ViewMaterialButtonComponent0 _compView_6;
  ...
  import45.ViewMaterialButtonComponent0 _compView_8;
  ...
  @override
  ComponentRef<import2.MaterialDateRangePickerComponent> build() {
    _compView_0 = import41.ViewFocusTrapComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    _el_0.className = 'popup-contents';
    addShimC(_el_0);
    _FocusTrapComponent_0_5 = import42.FocusTrapComponent();
    var doc = import3.document;
    final _el_1 = doc.createElement('div');
    _el_1.className = 'wrapper';
    addShimC(_el_1);
    _compView_2 = import43.ViewDateRangeEditorComponent0(this, 2);
    _el_2 = _compView_2.rootEl;
    _el_1.append(_el_2);
    addShimC(_el_2);
    _DateRangeEditorComponent_2_5 = (import17.isDevMode
        ? import20.debugInjectorWrap(import44.DateRangeEditorComponent, () {
            return import44.DateRangeEditorComponent(_el_2, parentView.parentView.injectorGet(import21.DomService, parentView.viewData.parentIndex), parentView.parentView.injectorGet(import47.ManagedZone, parentView.viewData.parentIndex), parentView.parentView.injectorGet(import44.DateRangeEditorHost, parentView.viewData.parentIndex, null), parentView.parentView.injectorGet(const import30.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), parentView.viewData.parentIndex, null), parentView.parentView.injectorGet(import48.Clock, parentView.viewData.parentIndex));
          })
        : import44.DateRangeEditorComponent(_el_2, parentView.parentView.injectorGet(import21.DomService, parentView.viewData.parentIndex), parentView.parentView.injectorGet(import47.ManagedZone, parentView.viewData.parentIndex), parentView.parentView.injectorGet(import44.DateRangeEditorHost, parentView.viewData.parentIndex, null), parentView.parentView.injectorGet(const import30.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), parentView.viewData.parentIndex, null), parentView.parentView.injectorGet(import48.Clock, parentView.viewData.parentIndex)));
    ...
    addShimC(_el_4);
    final _text_5 = import3.Text(' ');
    _el_4.append(_text_5);
    _compView_6 = import45.ViewMaterialButtonComponent0(this, 6);
    _el_6 = _compView_6.rootEl;
    _el_3.append(_el_6);
    _el_6.className = 'cancel';
    addShimC(_el_6);
    _AcxDarkTheme_6_5 = (import17.isDevMode
        ? import20.debugInjectorWrap(import49.AcxDarkTheme, () {
            return import49.AcxDarkTheme(parentView.parentView.injectorGet(const import30.OpaqueToken<dynamic>('acxDarkTheme'), parentView.viewData.parentIndex, null));
          })
        : import49.AcxDarkTheme(parentView.parentView.injectorGet(const import30.OpaqueToken<dynamic>('acxDarkTheme'), parentView.viewData.parentIndex, null)));
    ...
    _compView_8 = import45.ViewMaterialButtonComponent0(this, 8);
    _el_8 = _compView_8.rootEl;
    _el_3.append(_el_8);
    _el_8.className = 'apply';
    addShimC(_el_8);
    _AcxDarkTheme_8_5 = (import17.isDevMode
        ? import20.debugInjectorWrap(import49.AcxDarkTheme, () {
            return import49.AcxDarkTheme(parentView.parentView.injectorGet(const import30.OpaqueToken<dynamic>('acxDarkTheme'), parentView.viewData.parentIndex, null));
          })
        : import49.AcxDarkTheme(parentView.parentView.injectorGet(const import30.OpaqueToken<dynamic>('acxDarkTheme'), parentView.viewData.parentIndex, null)));
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import49.AcxDarkTheme) && ((6 <= nodeIndex) && (nodeIndex <= 7)))) {
      return _AcxDarkTheme_6_5;
    }
    if ((((identical(token, import46.MaterialButtonComponent) || identical(token, import19.ButtonDirective)) || identical(token, import35.HasDisabled)) && ((6 <= nodeIndex) && (nodeIndex <= 7)))) {
      return _MaterialButtonComponent_6_6;
    }
    if ((identical(token, import49.AcxDarkTheme) && ((8 <= nodeIndex) && (nodeIndex <= 9)))) {
      return _AcxDarkTheme_8_5;
    }
    if ((((identical(token, import46.MaterialButtonComponent) || identical(token, import19.ButtonDirective)) || identical(token, import35.HasDisabled)) && ((8 <= nodeIndex) && (nodeIndex <= 9)))) {
...
class _ViewMaterialDateRangePickerComponentHost0 extends AppView<import2.MaterialDateRangePickerComponent> {
  ...
  ComponentRef<import2.MaterialDateRangePickerComponent> build() {
    ...
    _MaterialDateRangePickerComponent_0_5 = (import17.isDevMode
        ? import20.debugInjectorWrap(import2.MaterialDateRangePickerComponent, () {
            return import2.MaterialDateRangePickerComponent(this.injectorGet(const import30.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), viewData.parentIndex, null), this.injectorGet(import48.Clock, viewData.parentIndex), this.injectorGet(import50.DatepickerConfig, viewData.parentIndex, null), null, this.injectorGet(import33.PopupSizeProvider, viewData.parentIndex, null), rootEl, this.injectorGet(import21.DomService, viewData.parentIndex), this.injectorGet(import27.NgZone, viewData.parentIndex));
          })
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((((identical(token, import44.DateRangeEditorHost) || identical(token, import35.HasDisabled)) || identical(token, import33.PopupSizeProvider)) && (0 == nodeIndex))) {

...
class ViewMaterialDateTimePickerComponent0 extends AppView<import2.MaterialDateTimePickerComponent> {
  ...
  ComponentRef<import2.MaterialDateTimePickerComponent> build() {
    ...
    addShimC(_el_0);
    _MaterialDatepickerComponent_0_5 = (import12.isDevMode
        ? import14.debugInjectorWrap(import5.MaterialDatepickerComponent, () {
            return import5.MaterialDatepickerComponent(_el_0, null, parentView.injectorGet(const import15.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), viewData.parentIndex, null));
          })
        : import5.MaterialDatepickerComponent(_el_0, null, parentView.injectorGet(const import15.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), viewData.parentIndex, null)));
    _compView_0.create(_MaterialDatepickerComponent_0_5, []);
    _compView_1 = import6.ViewMaterialTimePickerComponent0(this, 1);
    _el_1 = _compView_1.rootEl;
    parentRenderNode.append(_el_1);
    addShimC(_el_1);
    _MaterialTimePickerComponent_1_5 = (import12.isDevMode
        ? import14.debugInjectorWrap(import7.MaterialTimePickerComponent, () {
            return import7.MaterialTimePickerComponent(parentView.injectorGet(const import15.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), viewData.parentIndex));
          })
        : import7.MaterialTimePickerComponent(parentView.injectorGet(const import15.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), viewData.parentIndex)));
...
class _ViewMaterialDateTimePickerComponentHost0 extends AppView<import2.MaterialDateTimePickerComponent> {
  ...
  ComponentRef<import2.MaterialDateTimePickerComponent> build() {
    ...
    _MaterialDateTimePickerComponent_0_5 = (import12.isDevMode
        ? import14.debugInjectorWrap(import2.MaterialDateTimePickerComponent, () {
            return import2.MaterialDateTimePickerComponent(this.injectorGet(const import15.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), viewData.parentIndex));
          })
        : import2.MaterialDateTimePickerComponent(this.injectorGet(const import15.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), viewData.parentIndex)));

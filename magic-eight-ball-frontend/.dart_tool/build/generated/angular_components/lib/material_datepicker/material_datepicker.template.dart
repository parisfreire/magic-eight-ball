...
import '../material_input/material_input.template.dart' as import38;
import '../material_input/deferred_validator.dart' as import39;
import '../material_input/material_input.dart' as import40;
import '../focus/focus.dart' as import41;
import 'date_input.dart' as import42;
import '../material_input/material_input_default_value_accessor.dart' as import43;
import 'material_calendar_picker.template.dart' as import44;
import 'material_calendar_picker.dart' as import45;
import 'package:angular/src/common/directives/ng_class.dart' as import46;
import '../utils/browser/dom_service/dom_service.dart' as import47;
import '../laminate/components/modal/modal.dart' as import48;
import 'package:quiver/time.dart' as import49;
import '../material_input/base_material_input.dart' as import50;
import 'package:angular/src/common/directives/ng_for.dart' as import51;
import '../material_select/material_select_item.template.dart' as import52;
import '../material_select/material_select_item.dart' as import53;
import '../material_select/activation_handler.dart' as import54;
import '../model/selection/selection_container.dart' as import55;
import '../model/ui/has_renderer.dart' as import56;
import 'range.dart' as import57;
...
class ViewMaterialDatepickerComponent0 extends AppView<import2.MaterialDatepickerComponent> {
  ...
  ComponentRef<import2.MaterialDatepickerComponent> build() {
    ...
    addShimC(_el_0);
    _PopupSourceDirective_0_5 = (import18.isDevMode
        ? import20.debugInjectorWrap(import4.PopupSourceDirective, () {
            return import4.PopupSourceDirective(parentView.injectorGet(import21.DomPopupSourceFactory, viewData.parentIndex), _el_0, parentView.injectorGet(import22.ReferenceDirective, viewData.parentIndex, null), parentView.injectorGet(import23.Focusable, viewData.parentIndex, null), null);
          })
        : import4.PopupSourceDirective(parentView.injectorGet(import21.DomPopupSourceFactory, viewData.parentIndex), _el_0, parentView.injectorGet(import22.ReferenceDirective, viewData.parentIndex, null), parentView.injectorGet(import23.Focusable, viewData.parentIndex, null), null));
    ...
    _MaterialPopupComponent_3_8 = (import18.isDevMode
        ? import20.debugInjectorWrap(import10.MaterialPopupComponent, () {
            return import10.MaterialPopupComponent(parentView.injectorGet(import25.PopupHierarchy, viewData.parentIndex, null), parentView.injectorGet(import10.MaterialPopupComponent, viewData.parentIndex, null), null, parentView.injectorGet(import26.NgZone, viewData.parentIndex), parentView.injectorGet(import27.OverlayService, viewData.parentIndex), parentView.injectorGet(import28.ZIndexer, viewData.parentIndex), parentView.injectorGet(const import29.OpaqueToken<List<import31.RelativePosition>>('defaultPopupPositions'), viewData.parentIndex), parentView.injectorGet(const import29.OpaqueToken<dynamic>('overlayRepositionLoop'), viewData.parentIndex), parentView.injectorGet(import32.PopupSizeProvider, viewData.parentIndex, null), _compView_3.ref, _appEl_3, ElementRef(_el_3));
          })
        : import10.MaterialPopupComponent(parentView.injectorGet(import25.PopupHierarchy, viewData.parentIndex, null), parentView.injectorGet(import10.MaterialPopupComponent, viewData.parentIndex, null), null, parentView.injectorGet(import26.NgZone, viewData.parentIndex), parentView.injectorGet(import27.OverlayService, viewData.parentIndex), parentView.injectorGet(import28.ZIndexer, viewData.parentIndex), parentView.injectorGet(const import29.OpaqueToken<List<import31.RelativePosition>>('defaultPopupPositions'), viewData.parentIndex), parentView.injectorGet(const import29.OpaqueToken<dynamic>('overlayRepositionLoop'), viewData.parentIndex), parentView.injectorGet(import32.PopupSizeProvider, viewData.parentIndex, null), _compView_3.ref, _appEl_3, ElementRef(_el_3)));
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if (((identical(token, import34.HasDisabled) || identical(token, import23.Focusable)) && (2 == nodeIndex))) {
      return _DropdownButtonComponent_2_5;
    }
    if ((((identical(token, import10.MaterialPopupComponent) || identical(token, import35.DeferredContentAware)) || identical(token, import36.DropdownHandle)) && ((3 <= nodeIndex) && (nodeIndex <= 5)))) {
      return _MaterialPopupComponent_3_8;
    }
    if ((identical(token, import37.PopupRef) && ((3 <= nodeIndex) && (nodeIndex <= 5)))) {
      return _PopupRef_3_10;
    }
    if ((identical(token, import25.PopupHierarchy) && ((3 <= nodeIndex) && (nodeIndex <= 5)))) {
...
class _ViewMaterialDatepickerComponent2 extends AppView<import2.MaterialDatepickerComponent> {
  ...
  NgIf _NgIf_2_9;
  import3.Element _el_4;
  import38.ViewMaterialInputComponent0 _compView_4;
  import39.DeferredValidator _DeferredValidator_4_5;
  import40.MaterialInputComponent _MaterialInputComponent_4_6;
  import40.MaterialInputComponent _Focusable_4_7;
  import41.AutoFocusDirective _AutoFocusDirective_4_8;
  import42.DateInputDirective _DateInputDirective_4_9;
  import40.MaterialInputComponent _BaseMaterialInput_4_10;
  import43.MaterialInputDefaultValueAccessor _MaterialInputDefaultValueAccessor_4_11;
  List<dynamic> __NgValidators_4_12;
  ViewContainer _appEl_5;
  NgIf _NgIf_5_9;
  import3.Element _el_6;
  import44.ViewMaterialCalendarPickerComponent0 _compView_6;
  import45.MaterialCalendarPickerComponent _MaterialCalendarPickerComponent_6_5;
  import46.NgClass _NgClass_6_6;
  bool _expr_0;
  String _expr_2;
  bool _expr_3;
  var _expr_5;
  ...
  ComponentRef<import2.MaterialDatepickerComponent> build() {
    ...
    addShimC(_el_3);
    _compView_4 = import38.ViewMaterialInputComponent0(this, 4);
    _el_4 = _compView_4.rootEl;
    _el_3.append(_el_4);
    ...
    addShimC(_el_4);
    _DeferredValidator_4_5 = import39.DeferredValidator();
    _MaterialInputComponent_4_6 = import40.MaterialInputComponent('text', null, null, null, _compView_4.ref, _DeferredValidator_4_5);
    _Focusable_4_7 = _MaterialInputComponent_4_6;
    _AutoFocusDirective_4_8 = (import18.isDevMode
        ? import20.debugInjectorWrap(import41.AutoFocusDirective, () {
            return import41.AutoFocusDirective(_el_4, parentView.parentView.injectorGet(import47.DomService, parentView.viewData.parentIndex), _Focusable_4_7, parentView.parentView.injectorGet(import48.ModalComponent, parentView.viewData.parentIndex, null), import18.unsafeCast<ViewMaterialDatepickerComponent0>(parentView)._PopupRef_3_10);
          })
        : import41.AutoFocusDirective(_el_4, parentView.parentView.injectorGet(import47.DomService, parentView.viewData.parentIndex), _Focusable_4_7, parentView.parentView.injectorGet(import48.ModalComponent, parentView.viewData.parentIndex, null), import18.unsafeCast<ViewMaterialDatepickerComponent0>(parentView)._PopupRef_3_10));
    _DateInputDirective_4_9 = (import18.isDevMode
        ? import20.debugInjectorWrap(import42.DateInputDirective, () {
            return import42.DateInputDirective(parentView.parentView.injectorGet(const import29.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), parentView.viewData.parentIndex, null), parentView.parentView.injectorGet(import49.Clock, parentView.viewData.parentIndex), _MaterialInputComponent_4_6);
          })
        : import42.DateInputDirective(parentView.parentView.injectorGet(const import29.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), parentView.viewData.parentIndex, null), parentView.parentView.injectorGet(import49.Clock, parentView.viewData.parentIndex), _MaterialInputComponent_4_6));
    _BaseMaterialInput_4_10 = _MaterialInputComponent_4_6;
    _MaterialInputDefaultValueAccessor_4_11 = import43.MaterialInputDefaultValueAccessor(_BaseMaterialInput_4_10, null);
    ...
    _compView_6 = import44.ViewMaterialCalendarPickerComponent0(this, 6);
    _el_6 = _compView_6.rootEl;
    _el_0.append(_el_6);
    _el_6.className = 'calendar-picker';
    createAttr(_el_6, 'mode', 'single-date');
    addShimC(_el_6);
    _MaterialCalendarPickerComponent_6_5 = (import18.isDevMode
        ? import20.debugInjectorWrap(import45.MaterialCalendarPickerComponent, () {
            return import45.MaterialCalendarPickerComponent(parentView.parentView.injectorGet(const import29.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), parentView.viewData.parentIndex, null), parentView.parentView.injectorGet(import49.Clock, parentView.viewData.parentIndex), 'single-date');
          })
        : import45.MaterialCalendarPickerComponent(parentView.parentView.injectorGet(const import29.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), parentView.viewData.parentIndex, null), parentView.parentView.injectorGet(import49.Clock, parentView.viewData.parentIndex), 'single-date'));
    _NgClass_6_6 = import46.NgClass(_el_6);
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import39.DeferredValidator) && (4 == nodeIndex))) {
      return _DeferredValidator_4_5;
    }
    if ((((identical(token, import40.MaterialInputComponent) || identical(token, import22.ReferenceDirective)) || identical(token, import34.HasDisabled)) && (4 == nodeIndex))) {
      return _MaterialInputComponent_4_6;
    }
    if ((identical(token, import23.Focusable) && (4 == nodeIndex))) {
      return _Focusable_4_7;
    }
    if ((identical(token, import50.BaseMaterialInput) && (4 == nodeIndex))) {
      return _BaseMaterialInput_4_10;
    }
    if ((identical(token, import43.MaterialInputDefaultValueAccessor) && (4 == nodeIndex))) {
      return _MaterialInputDefaultValueAccessor_4_11;
    }
    if ((identical(token, const import29.MultiToken<dynamic>('NgValidators')) && (4 == nodeIndex))) {
...
class _ViewMaterialDatepickerComponent4 extends AppView<import2.MaterialDatepickerComponent> {
  ...
  ComponentRef<import2.MaterialDatepickerComponent> build() {
    ...
    _NgFor_1_9 = import51.NgFor(_appEl_1, _TemplateRef_1_8);
    init0(_el_0);
  }
...
class _ViewMaterialDatepickerComponent5 extends AppView<import2.MaterialDatepickerComponent> {
  ...
  import52.ViewMaterialSelectItemComponent0 _compView_0;
  import53.MaterialSelectItemComponent _MaterialSelectItemComponent_0_5;
  import3.Text _text_1;
  var _expr_0;
  var _expr_2;
  ...
  @override
  ComponentRef<import2.MaterialDatepickerComponent> build() {
    _compView_0 = import52.ViewMaterialSelectItemComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    createAttr(_el_0, 'closeOnActivate', 'false');
    addShimC(_el_0);
    _MaterialSelectItemComponent_0_5 = (import18.isDevMode
        ? import20.debugInjectorWrap(import53.MaterialSelectItemComponent, () {
            return import53.MaterialSelectItemComponent(_el_0, import18.unsafeCast<ViewMaterialDatepickerComponent0>(parentView.parentView.parentView)._MaterialPopupComponent_3_8, parentView.parentView.parentView.parentView.injectorGet(import54.ActivationHandler, parentView.parentView.parentView.viewData.parentIndex, null), _compView_0.ref, null);
          })
        : import53.MaterialSelectItemComponent(_el_0, import18.unsafeCast<ViewMaterialDatepickerComponent0>(parentView.parentView.parentView)._MaterialPopupComponent_3_8, parentView.parentView.parentView.parentView.injectorGet(import54.ActivationHandler, parentView.parentView.parentView.viewData.parentIndex, null), _compView_0.ref, null));
    _text_1 = import3.Text('');
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((((identical(token, import55.SelectionItem) || identical(token, import34.HasDisabled)) || identical(token, import56.HasRenderer)) && ((0 <= nodeIndex) && (nodeIndex <= 1)))) {
  ...
  void detectChangesInternal() {
    final _ctx = ctx;
    bool firstCheck = (this.cdState == 0);
    final local_presetDate = import18.unsafeCast<import57.SingleDayRange>(locals['\$implicit']);
    if (firstCheck) {
...
class _ViewMaterialDatepickerComponentHost0 extends AppView<import2.MaterialDatepickerComponent> {
  ...
  ComponentRef<import2.MaterialDatepickerComponent> build() {
    ...
    _MaterialDatepickerComponent_0_5 = (import18.isDevMode
        ? import20.debugInjectorWrap(import2.MaterialDatepickerComponent, () {
            return import2.MaterialDatepickerComponent(rootEl, null, this.injectorGet(const import29.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), viewData.parentIndex, null));
          })
        : import2.MaterialDatepickerComponent(rootEl, null, this.injectorGet(const import29.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), viewData.parentIndex, null)));

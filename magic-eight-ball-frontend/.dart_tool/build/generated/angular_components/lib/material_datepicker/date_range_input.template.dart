...
import 'package:quiver/time.dart' as import17;
...
class ViewDateRangeInputComponent0 extends AppView<import2.DateRangeInputComponent> {
  ...
  ComponentRef<import2.DateRangeInputComponent> build() {
    ...
    _DateInputDirective_0_7 = (import13.isDevMode
        ? import15.debugInjectorWrap(import7.DateInputDirective, () {
            return import7.DateInputDirective(parentView.injectorGet(const import16.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), viewData.parentIndex, null), parentView.injectorGet(import17.Clock, viewData.parentIndex), _MaterialInputComponent_0_6);
          })
        : import7.DateInputDirective(parentView.injectorGet(const import16.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), viewData.parentIndex, null), parentView.injectorGet(import17.Clock, viewData.parentIndex), _MaterialInputComponent_0_6));
    ...
    final _el_1 = createSpanAndAppend(doc, parentRenderNode);
    ...
    _DateInputDirective_3_7 = (import13.isDevMode
        ? import15.debugInjectorWrap(import7.DateInputDirective, () {
            return import7.DateInputDirective(parentView.injectorGet(const import16.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), viewData.parentIndex, null), parentView.injectorGet(import17.Clock, viewData.parentIndex), _MaterialInputComponent_3_6);
          })
        : import7.DateInputDirective(parentView.injectorGet(const import16.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), viewData.parentIndex, null), parentView.injectorGet(import17.Clock, viewData.parentIndex), _MaterialInputComponent_3_6));
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    ...
    if (((((identical(token, import6.MaterialInputComponent) || identical(token, import18.ReferenceDirective)) || identical(token, import19.Focusable)) || identical(token, import20.HasDisabled)) && (0 == nodeIndex))) {
    ...
    if ((identical(token, const import16.MultiToken<dynamic>('NgValidators')) && (0 == nodeIndex))) {
      return _NgValidators_0_10;
    }
    if ((identical(token, import5.DeferredValidator) && (3 == nodeIndex))) {
      return _DeferredValidator_3_5;
    }
    if (((((identical(token, import6.MaterialInputComponent) || identical(token, import18.ReferenceDirective)) || identical(token, import19.Focusable)) || identical(token, import20.HasDisabled)) && (3 == nodeIndex))) {
      return _MaterialInputComponent_3_6;
    }
    if ((identical(token, import21.BaseMaterialInput) && (3 == nodeIndex))) {
    ...
    if ((identical(token, const import16.MultiToken<dynamic>('NgValidators')) && (3 == nodeIndex))) {

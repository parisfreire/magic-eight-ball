...
class ViewNextPrevComponent0 extends AppView<import2.NextPrevComponent> {
  ...
  import4.ViewMaterialIconComponent0 _compView_4;
  import5.MaterialIconComponent _MaterialIconComponent_4_5;
  bool _expr_0;
  var _expr_1;
  var _expr_2;
  var _expr_3;
  ...
  ComponentRef<import2.NextPrevComponent> build() {
    ...
    addShimC(_el_3);
    _compView_4 = import4.ViewMaterialIconComponent0(this, 4);
    _el_4 = _compView_4.rootEl;
    _el_3.append(_el_4);
    createAttr(_el_4, 'icon', 'navigate_next');
    addShimC(_el_4);
    _MaterialIconComponent_4_5 = import5.MaterialIconComponent(_el_4);
  ...
  void detectChangesInternal() {
    ...
    if (import9.checkBinding(_expr_3, currVal_3)) {
      setAttr(_el_1, 'aria-label', currVal_3);
      _expr_3 = currVal_3;
    }
    ...
    if (import9.checkBinding(_expr_8, currVal_8)) {
      setAttr(_el_4, 'aria-label', currVal_8);
      _expr_8 = currVal_8;
    }

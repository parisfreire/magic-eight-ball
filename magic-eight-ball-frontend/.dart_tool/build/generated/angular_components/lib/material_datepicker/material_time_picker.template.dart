...
import '../material_select/activation_handler.dart' as import30;
...
class ViewMaterialTimePickerComponent0 extends AppView<import2.MaterialTimePickerComponent> {
  ...
  ComponentRef<import2.MaterialTimePickerComponent> build() {
    ...
    _MaterialDropdownSelectComponent_0_5 = (import15.isDevMode
        ? import17.debugInjectorWrap(import5.MaterialDropdownSelectComponent, () {
            return import5.MaterialDropdownSelectComponent(parentView.injectorGet(import18.IdGenerator, viewData.parentIndex, null), parentView.injectorGet(import19.PopupSizeProvider, viewData.parentIndex, null), parentView.injectorGet(const import20.OpaqueToken<dynamic>('isRtl'), viewData.parentIndex, null), null, null, _el_0);
          })
        : import5.MaterialDropdownSelectComponent(parentView.injectorGet(import18.IdGenerator, viewData.parentIndex, null), parentView.injectorGet(import19.PopupSizeProvider, viewData.parentIndex, null), parentView.injectorGet(const import20.OpaqueToken<dynamic>('isRtl'), viewData.parentIndex, null), null, null, _el_0));
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    ...
    if ((identical(token, const import20.MultiToken<dynamic>('NgValidators')) && (3 == nodeIndex))) {
      return _NgValidators_3_6;
    }
    if ((identical(token, import8.NgModel) && (3 == nodeIndex))) {
      return _NgModel_3_7;
    }
    if ((identical(token, import21.NgControl) && (3 == nodeIndex))) {
      return _NgControl_3_8;
    }
    if (((((identical(token, import9.MaterialInputComponent) || identical(token, import22.ReferenceDirective)) || identical(token, import23.Focusable)) || identical(token, import24.HasDisabled)) && (3 == nodeIndex))) {
      return _MaterialInputComponent_3_9;
    }
    if ((identical(token, import25.BaseMaterialInput) && (3 == nodeIndex))) {
    ...
    if (((((((((identical(token, import5.MaterialDropdownSelectComponent) || identical(token, import26.DropdownHandle)) || identical(token, import24.HasDisabled)) || identical(token, import27.HasRenderer)) || identical(token, import28.DeferredContentAware)) || identical(token, import29.SelectionContainer)) || identical(token, import19.PopupSizeProvider)) || identical(token, import30.ActivationHandler)) && ((0 <= nodeIndex) && (nodeIndex <= 3)))) {
  ...
  void detectChangesInternal() {
    ...
    if (import14.checkBinding(_expr_2, currVal_2)) {
      ...
      changes ??= <String, SimpleChange>{};
      changes['selectionInput'] = SimpleChange(_expr_2, currVal_2);
      _expr_2 = currVal_2;
    }
    ...
    if (import14.checkBinding(_expr_5, currVal_5)) {
      ...
      changes ??= <String, SimpleChange>{};
      changes['visible'] = SimpleChange(_expr_5, currVal_5);
      _expr_5 = currVal_5;
    }
    ...
    if (import14.checkBinding(_expr_6, currVal_6)) {
      ...
      changes ??= <String, SimpleChange>{};
      changes['error'] = SimpleChange(_expr_6, currVal_6);
      _expr_6 = currVal_6;
    }
    ...
    if (import14.checkBinding(_expr_8, currVal_8)) {
      ...
      changes ??= <String, SimpleChange>{};
      changes['optionsInput'] = SimpleChange(_expr_8, currVal_8);
      _expr_8 = currVal_8;
    }
...
class _ViewMaterialTimePickerComponentHost0 extends AppView<import2.MaterialTimePickerComponent> {
  ...
  ComponentRef<import2.MaterialTimePickerComponent> build() {
    ...
    _MaterialTimePickerComponent_0_5 = (import15.isDevMode
        ? import17.debugInjectorWrap(import2.MaterialTimePickerComponent, () {
            return import2.MaterialTimePickerComponent(this.injectorGet(const import20.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), viewData.parentIndex));
          })
        : import2.MaterialTimePickerComponent(this.injectorGet(const import20.OpaqueToken<dynamic>('third_party.dart_src.acx.material_datepicker.datepickerClock'), viewData.parentIndex)));

...
class ViewMaterialExpansionPanel0 extends AppView<import2.MaterialExpansionPanel> {
  ...
  import8.DeferredContentDirective _DeferredContentDirective_17_9;
  var _expr_0;
  var _expr_1;
  bool _expr_2;
  bool _expr_3;
  ...
  ComponentRef<import2.MaterialExpansionPanel> build() {
    ...
    addShimC(_el_2);
    _ButtonDirective_2_5 = import5.ButtonDirectiveNgCd(import15.ButtonDirective(_el_2, null));
    ...
    _DeferredContentDirective_17_9 = (import13.isDevMode
        ? import17.debugInjectorWrap(import8.DeferredContentDirective, () {
            return import8.DeferredContentDirective(_appEl_17, _TemplateRef_17_8, parentView.injectorGet(import18.DeferredContentAware, viewData.parentIndex));
          })
        : import8.DeferredContentDirective(_appEl_17, _TemplateRef_17_8, parentView.injectorGet(import18.DeferredContentAware, viewData.parentIndex)));
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    ...
    if ((identical(token, import4.KeyUpBoundaryDirective) && ((0 <= nodeIndex) && (nodeIndex <= 17)))) {
...
class _ViewMaterialExpansionPanel9 extends AppView<import2.MaterialExpansionPanel> {
  ...
  ComponentRef<import2.MaterialExpansionPanel> build() {
    ...
    _EnterAcceptsDirective_0_6 = import4.EnterAcceptsDirective(_MaterialYesNoButtonsComponent_0_5, _el_0, import13.unsafeCast<ViewMaterialExpansionPanel0>(parentView.parentView)._KeyUpBoundaryDirective_0_5);

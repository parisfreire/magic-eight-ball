...
class ViewMaterialSelectComponent0<T> extends AppView<import2.MaterialSelectComponent<T>> {
  ...
  ComponentRef<import2.MaterialSelectComponent<T>> build() {
    ...
    _compView_0 = import4.ViewMaterialListComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    parentRenderNode.append(_el_0);
    addShimC(_el_0);
    _MaterialListComponent_0_5 = import5.MaterialListComponent();
...
class _ViewMaterialSelectComponent2<T> extends AppView<import2.MaterialSelectComponent<T>> {
  ...
  @override
  void detectChangesInternal() {
    final local_group = import12.unsafeCast<import16.OptionGroup<dynamic>>(locals['\$implicit']);
...
class _ViewMaterialSelectComponent3<T> extends AppView<import2.MaterialSelectComponent<T>> {
  ...
  @override
  void detectChangesInternal() {
    final local_group = import12.unsafeCast<import16.OptionGroup<dynamic>>(parentView.locals['\$implicit']);
...
class _ViewMaterialSelectComponent4<T> extends AppView<import2.MaterialSelectComponent<T>> {
  ...
  @override
  void detectChangesInternal() {
    final local_group = import12.unsafeCast<import16.OptionGroup<dynamic>>(parentView.parentView.locals['\$implicit']);

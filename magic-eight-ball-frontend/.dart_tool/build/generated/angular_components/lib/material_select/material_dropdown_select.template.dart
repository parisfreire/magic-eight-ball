...
import '../material_list/material_list.dart' as import37;
...
class ViewMaterialDropdownSelectComponent0<T> extends AppView<import2.MaterialDropdownSelectComponent<T>> {
  ...
  ComponentRef<import2.MaterialDropdownSelectComponent<T>> build() {
    ...
    _PopupSourceDirective_0_7 = (import15.isDevMode
        ? import17.debugInjectorWrap(import6.PopupSourceDirective, () {
            return import6.PopupSourceDirective(parentView.injectorGet(import18.DomPopupSourceFactory, viewData.parentIndex), _el_0, parentView.injectorGet(import19.ReferenceDirective, viewData.parentIndex, null), _Focusable_0_6, 'false');
          })
        : import6.PopupSourceDirective(parentView.injectorGet(import18.DomPopupSourceFactory, viewData.parentIndex), _el_0, parentView.injectorGet(import19.ReferenceDirective, viewData.parentIndex, null), _Focusable_0_6, 'false'));
    final _text_1 = import3.Text(' ');
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import30.HasDisabled) && ((0 <= nodeIndex) && (nodeIndex <= 1)))) {
      return _DropdownButtonComponent_0_5;
    }
    if ((identical(token, import31.Focusable) && ((0 <= nodeIndex) && (nodeIndex <= 1)))) {
      return _Focusable_0_6;
    }
    if ((((identical(token, import9.MaterialPopupComponent) || identical(token, import32.DeferredContentAware)) || identical(token, import33.DropdownHandle)) && ((2 <= nodeIndex) && (nodeIndex <= 5)))) {
      return _MaterialPopupComponent_2_8;
    }
    if ((identical(token, import34.PopupRef) && ((2 <= nodeIndex) && (nodeIndex <= 5)))) {
...
class _ViewMaterialDropdownSelectComponent1<T> extends AppView<import2.MaterialDropdownSelectComponent<T>> {
  ...
  import36.AutoFocusDirective _AutoFocusDirective_0_5;
  import37.MaterialListComponent _MaterialListComponent_0_6;
  ViewContainer _appEl_2;
  NgIf _NgIf_2_9;
  var _expr_1;
  bool _expr_2;
  ...
  ComponentRef<import2.MaterialDropdownSelectComponent<T>> build() {
    ...
    _AutoFocusDirective_0_5 = (import15.isDevMode
        ? import17.debugInjectorWrap(import36.AutoFocusDirective, () {
            return import36.AutoFocusDirective(_el_0, parentView.parentView.injectorGet(import39.DomService, parentView.viewData.parentIndex), null, parentView.parentView.injectorGet(import40.ModalComponent, parentView.viewData.parentIndex, null), import15.unsafeCast<ViewMaterialDropdownSelectComponent0>(parentView)._PopupRef_2_10);
          })
        : import36.AutoFocusDirective(_el_0, parentView.parentView.injectorGet(import39.DomService, parentView.viewData.parentIndex), null, parentView.parentView.injectorGet(import40.ModalComponent, parentView.viewData.parentIndex, null), import15.unsafeCast<ViewMaterialDropdownSelectComponent0>(parentView)._PopupRef_2_10));
    _MaterialListComponent_0_6 = import37.MaterialListComponent();
    final _text_1 = import3.Text(' ');
  ...
  ComponentRef<import2.MaterialDropdownSelectComponent<T>> build() {
    ...
    _ActiveItemDirective_0_5 = import43.ActiveItemDirectiveNgCd((import15.isDevMode
        ? import17.debugInjectorWrap(import46.ActiveItemDirective, () {
            return import46.ActiveItemDirective(_el_0, parentView.parentView.parentView.parentView.injectorGet(import39.DomService, parentView.parentView.parentView.viewData.parentIndex), parentView.parentView.parentView.parentView.injectorGet(import40.Modal, parentView.parentView.parentView.viewData.parentIndex, null), import15.unsafeCast<ViewMaterialDropdownSelectComponent0>(parentView.parentView.parentView)._PopupRef_2_10);
          })
        : import46.ActiveItemDirective(_el_0, parentView.parentView.parentView.parentView.injectorGet(import39.DomService, parentView.parentView.parentView.viewData.parentIndex), parentView.parentView.parentView.parentView.injectorGet(import40.Modal, parentView.parentView.parentView.viewData.parentIndex, null), import15.unsafeCast<ViewMaterialDropdownSelectComponent0>(parentView.parentView.parentView)._PopupRef_2_10)));
    _KeyboardOnlyFocusIndicatorDirective_0_6 = (import15.isDevMode
        ? import17.debugInjectorWrap(import44.KeyboardOnlyFocusIndicatorDirective, () {
            return import44.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.parentView.parentView.injectorGet(import39.DomService, parentView.parentView.parentView.viewData.parentIndex));
          })
        : import44.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.parentView.parentView.injectorGet(import39.DomService, parentView.parentView.parentView.viewData.parentIndex)));
...
class _ViewMaterialDropdownSelectComponent4<T> extends AppView<import2.MaterialDropdownSelectComponent<T>> {
  ...
  @override
  void detectChangesInternal() {
    final local_group = import15.unsafeCast<import51.OptionGroup<dynamic>>(locals['\$implicit']);
...
class _ViewMaterialDropdownSelectComponent5<T> extends AppView<import2.MaterialDropdownSelectComponent<T>> {
  ...
  void detectChangesInternal() {
    final _ctx = ctx;
    final local_group = import15.unsafeCast<import51.OptionGroup<dynamic>>(parentView.locals['\$implicit']);
...
class _ViewMaterialDropdownSelectComponent6<T> extends AppView<import2.MaterialDropdownSelectComponent<T>> {
  ...
  @override
  void detectChangesInternal() {
    final local_group = import15.unsafeCast<import51.OptionGroup<dynamic>>(parentView.parentView.locals['\$implicit']);
...
class _ViewMaterialDropdownSelectComponent9<T> extends AppView<import2.MaterialDropdownSelectComponent<T>> {
  ...
  ComponentRef<import2.MaterialDropdownSelectComponent<T>> build() {
    ...
    _ActiveItemDirective_0_5 = import43.ActiveItemDirectiveNgCd((import15.isDevMode
        ? import17.debugInjectorWrap(import46.ActiveItemDirective, () {
            return import46.ActiveItemDirective(_el_0, parentView.parentView.parentView.parentView.parentView.parentView.parentView.injectorGet(import39.DomService, parentView.parentView.parentView.parentView.parentView.parentView.viewData.parentIndex), parentView.parentView.parentView.parentView.parentView.parentView.parentView.injectorGet(import40.Modal, parentView.parentView.parentView.parentView.parentView.parentView.viewData.parentIndex, null), import15.unsafeCast<ViewMaterialDropdownSelectComponent0>(parentView.parentView.parentView.parentView.parentView.parentView)._PopupRef_2_10);
          })
        : import46.ActiveItemDirective(_el_0, parentView.parentView.parentView.parentView.parentView.parentView.parentView.injectorGet(import39.DomService, parentView.parentView.parentView.parentView.parentView.parentView.viewData.parentIndex), parentView.parentView.parentView.parentView.parentView.parentView.parentView.injectorGet(import40.Modal, parentView.parentView.parentView.parentView.parentView.parentView.viewData.parentIndex, null), import15.unsafeCast<ViewMaterialDropdownSelectComponent0>(parentView.parentView.parentView.parentView.parentView.parentView)._PopupRef_2_10)));
    _KeyboardOnlyFocusIndicatorDirective_0_6 = (import15.isDevMode
        ? import17.debugInjectorWrap(import44.KeyboardOnlyFocusIndicatorDirective, () {
            return import44.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.parentView.parentView.parentView.parentView.parentView.injectorGet(import39.DomService, parentView.parentView.parentView.parentView.parentView.parentView.viewData.parentIndex));
          })
        : import44.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.parentView.parentView.parentView.parentView.parentView.injectorGet(import39.DomService, parentView.parentView.parentView.parentView.parentView.parentView.viewData.parentIndex)));
    _MaterialSelectDropdownItemComponent_0_7 = (import15.isDevMode
        ? import17.debugInjectorWrap(import45.MaterialSelectDropdownItemComponent, () {
...
class _ViewMaterialDropdownSelectComponent10<T> extends AppView<import2.MaterialDropdownSelectComponent<T>> {
  ...
  ComponentRef<import2.MaterialDropdownSelectComponent<T>> build() {
    ...
    _KeyboardOnlyFocusIndicatorDirective_0_5 = (import15.isDevMode
        ? import17.debugInjectorWrap(import44.KeyboardOnlyFocusIndicatorDirective, () {
            return import44.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.parentView.parentView.parentView.parentView.injectorGet(import39.DomService, parentView.parentView.parentView.parentView.parentView.viewData.parentIndex));
          })
        : import44.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.parentView.parentView.parentView.parentView.injectorGet(import39.DomService, parentView.parentView.parentView.parentView.parentView.viewData.parentIndex)));
...
class _ViewMaterialDropdownSelectComponentHost0<T> extends AppView<import2.MaterialDropdownSelectComponent<T>> {
  ...
  ComponentRef<import2.MaterialDropdownSelectComponent<T>> build() {
    ...
    _MaterialDropdownSelectComponent_0_5 = (import15.isDevMode
        ? import17.debugInjectorWrap(import2.MaterialDropdownSelectComponent, () {
            return import2.MaterialDropdownSelectComponent(this.injectorGet(import48.IdGenerator, viewData.parentIndex, null), this.injectorGet(import27.PopupSizeProvider, viewData.parentIndex, null), this.injectorGet(const import24.OpaqueToken<dynamic>('isRtl'), viewData.parentIndex, null), null, null, rootEl);
          })
        : import2.MaterialDropdownSelectComponent(this.injectorGet(import48.IdGenerator, viewData.parentIndex, null), this.injectorGet(import27.PopupSizeProvider, viewData.parentIndex, null), this.injectorGet(const import24.OpaqueToken<dynamic>('isRtl'), viewData.parentIndex, null), null, null, rootEl));
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if (((((((((identical(token, import2.MaterialDropdownSelectComponent) || identical(token, import33.DropdownHandle)) || identical(token, import30.HasDisabled)) || identical(token, import50.HasRenderer)) || identical(token, import32.DeferredContentAware)) || identical(token, import49.SelectionContainer)) || identical(token, import27.PopupSizeProvider)) || identical(token, import47.ActivationHandler)) && (0 == nodeIndex))) {

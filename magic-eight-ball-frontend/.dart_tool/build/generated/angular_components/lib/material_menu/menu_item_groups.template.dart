    ...
    if ((this.__TooltipController_1_19 == null)) {
      (__TooltipController_1_19 = (import12.isDevMode
          ? import29.debugInjectorWrap(import30.TooltipController, () {
              return import31.createTooltipController(this.parentView.parentView.parentView.parentView.parentView.injectorGet(import30.TooltipController, this.parentView.parentView.parentView.parentView.viewData.parentIndex, null), this.parentView.parentView.parentView.parentView.parentView.injectorGet(import32.Disposer, this.parentView.parentView.parentView.parentView.viewData.parentIndex, null));
            })
          : import31.createTooltipController(this.parentView.parentView.parentView.parentView.parentView.injectorGet(import30.TooltipController, this.parentView.parentView.parentView.parentView.viewData.parentIndex, null), this.parentView.parentView.parentView.parentView.parentView.injectorGet(import32.Disposer, this.parentView.parentView.parentView.parentView.viewData.parentIndex, null))));
    }
  ...
  ComponentRef<import2.MenuItemGroupsComponent> build() {
    ...
    _MaterialTooltipDirective_1_11 = (import12.isDevMode
        ? import29.debugInjectorWrap(import25.MaterialTooltipDirective, () {
            return import25.MaterialTooltipDirective(parentView.parentView.parentView.parentView.parentView.injectorGet(import37.DomPopupSourceFactory, parentView.parentView.parentView.parentView.viewData.parentIndex), _appEl_1, _el_1, _appEl_1, _compView_1.ref, parentView.parentView.parentView.parentView.parentView.injectorGet(import3.Window, parentView.parentView.parentView.parentView.viewData.parentIndex));
          })
...
class _ViewMenuItemGroupsComponent15 extends AppView<import2.MenuItemGroupsComponent> {
  ...
  dynamic get _PopupRef_0_10 {
    if ((this.__PopupRef_0_10 == null)) {
      (__PopupRef_0_10 = import51.getResolvedPopupRef(this._MaterialPopupComponent_0_8));
    }
  ...
  dynamic get _PopupHierarchy_0_12 {
    if ((this.__PopupHierarchy_0_12 == null)) {
      (__PopupHierarchy_0_12 = import51.getHierarchy(this._MaterialPopupComponent_0_8));
    }

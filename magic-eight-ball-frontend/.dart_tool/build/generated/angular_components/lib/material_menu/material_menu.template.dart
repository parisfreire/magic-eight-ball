...
import 'package:angular_components/utils/angular/css/css.template.dart' as _ref11;
...
import '../material_button/material_button.dart' as import5;
...
import 'menu_popup.template.dart' as import29;
import 'menu_popup.dart' as import30;
...
class ViewMaterialMenuComponent0 extends AppView<import1.MaterialMenuComponent> {
  ...
  import5.MaterialButtonComponent _MaterialButtonComponent_0_9;
  import6.MaterialTooltipDirective _MaterialTooltipDirective_0_10;
  import7.PopupSourceDirective _PopupSourceDirective_0_11;
  ...
  ViewMaterialMenuComponent0(AppView<dynamic> parentView, int parentIndex) : super(import10.ViewType.component, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckOnce) {
    ...
    _renderType ??= import12.appViewUtils.createRenderType((import13.isDevMode ? 'asset:angular_components/lib/material_menu/material_menu.dart' : null), ViewEncapsulation.None, styles$MaterialMenuComponent);
    setupComponentType(_renderType);
  }
  dynamic get _TooltipController_0_14 {
    if ((this.__TooltipController_0_14 == null)) {
      (__TooltipController_0_14 = (import13.isDevMode
          ? import15.debugInjectorWrap(import16.TooltipController, () {
              return import17.createTooltipController(this.parentView.injectorGet(import16.TooltipController, this.viewData.parentIndex, null), this.parentView.injectorGet(import18.Disposer, this.viewData.parentIndex, null));
            })
          : import17.createTooltipController(this.parentView.injectorGet(import16.TooltipController, this.viewData.parentIndex, null), this.parentView.injectorGet(import18.Disposer, this.viewData.parentIndex, null))));
    }
  ...
  ComponentRef<import1.MaterialMenuComponent> build() {
    ...
    _AcxDarkTheme_0_8 = (import13.isDevMode
        ? import15.debugInjectorWrap(import19.AcxDarkTheme, () {
    ...
    _MaterialButtonComponent_0_9 = import5.MaterialButtonComponent(_el_0, _AcxDarkTheme_0_8, _compView_0.ref, null);
    _MaterialTooltipDirective_0_10 = (import13.isDevMode
        ? import15.debugInjectorWrap(import6.MaterialTooltipDirective, () {
            return import6.MaterialTooltipDirective(parentView.injectorGet(import21.DomPopupSourceFactory, viewData.parentIndex), _appEl_0, _el_0, _appEl_0, _compView_0.ref, parentView.injectorGet(import2.Window, viewData.parentIndex));
          })
        : import6.MaterialTooltipDirective(parentView.injectorGet(import21.DomPopupSourceFactory, viewData.parentIndex), _appEl_0, _el_0, _appEl_0, _compView_0.ref, parentView.injectorGet(import2.Window, viewData.parentIndex)));
    _PopupSourceDirective_0_11 = (import13.isDevMode
        ? import15.debugInjectorWrap(import7.PopupSourceDirective, () {
            return import7.PopupSourceDirective(parentView.injectorGet(import21.DomPopupSourceFactory, viewData.parentIndex), _el_0, parentView.injectorGet(import22.ReferenceDirective, viewData.parentIndex, null), parentView.injectorGet(import23.Focusable, viewData.parentIndex, null), null);
          })
        : import7.PopupSourceDirective(parentView.injectorGet(import21.DomPopupSourceFactory, viewData.parentIndex), _el_0, parentView.injectorGet(import22.ReferenceDirective, viewData.parentIndex, null), parentView.injectorGet(import23.Focusable, viewData.parentIndex, null), null));
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import19.AcxDarkTheme) && ((0 <= nodeIndex) && (nodeIndex <= 3)))) {
      return _AcxDarkTheme_0_8;
    }
    if ((((identical(token, import5.MaterialButtonComponent) || identical(token, import25.ButtonDirective)) || identical(token, import26.HasDisabled)) && ((0 <= nodeIndex) && (nodeIndex <= 3)))) {
      return _MaterialButtonComponent_0_9;
    }
    if ((identical(token, import16.TooltipController) && ((0 <= nodeIndex) && (nodeIndex <= 3)))) {
  ...
  void detectChangesInternal() {
    ...
    if (!import12.AppViewUtils.throwOnChanges) {
      if (_query_MenuPopupComponent_1_1_isDirty) {
        ctx.menuPopup = import12.firstOrNull(_appEl_4.mapNestedViews((_ViewMaterialMenuComponent3 nestedView) {
...
class _ViewMaterialMenuComponent1 extends AppView<import1.MaterialMenuComponent> {
  import2.Element _el_0;
  import27.ViewMaterialIconComponent0 _compView_0;
  import28.MaterialIconComponent _MaterialIconComponent_0_5;
  var _expr_0;
  ...
  @override
  ComponentRef<import1.MaterialMenuComponent> build() {
    _compView_0 = import27.ViewMaterialIconComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    _MaterialIconComponent_0_5 = import28.MaterialIconComponent(_el_0);
...
class _ViewMaterialMenuComponent3 extends AppView<import1.MaterialMenuComponent> {
  import2.Element _el_0;
  import29.ViewMenuPopupComponent0 _compView_0;
  import30.MenuPopupComponent _MenuPopupComponent_0_5;
  import7.PopupSourceDirective _PopupSourceDirective_0_6;
  var _expr_0;
  var _expr_1;
  var _expr_2;
  var _expr_3;
  ...
  @override
  ComponentRef<import1.MaterialMenuComponent> build() {
    _compView_0 = import29.ViewMenuPopupComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    _MenuPopupComponent_0_5 = import30.MenuPopupComponent();
    _PopupSourceDirective_0_6 = (import13.isDevMode
        ? import15.debugInjectorWrap(import7.PopupSourceDirective, () {
            return import7.PopupSourceDirective(parentView.injectorGet(import21.DomPopupSourceFactory, viewData.parentIndex), _el_0, parentView.injectorGet(import22.ReferenceDirective, viewData.parentIndex, null), parentView.injectorGet(import23.Focusable, viewData.parentIndex, null), null);
          })
        : import7.PopupSourceDirective(parentView.injectorGet(import21.DomPopupSourceFactory, viewData.parentIndex), _el_0, parentView.injectorGet(import22.ReferenceDirective, viewData.parentIndex, null), parentView.injectorGet(import23.Focusable, viewData.parentIndex, null), null));
  ...
  void detectChangesInternal() {
    ...
    bool changed = false;
    bool firstCheck = (this.cdState == 0);
    final local_toggle = import13.unsafeCast<ViewMaterialMenuComponent0>(parentView)._PopupSourceDirective_0_11;
    changed = false;
  ...
  void dirtyParentQueriesInternal() {
    import13.unsafeCast<ViewMaterialMenuComponent0>(parentView)._query_MenuPopupComponent_1_1_isDirty = true;
  }

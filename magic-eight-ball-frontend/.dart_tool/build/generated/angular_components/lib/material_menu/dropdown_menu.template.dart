...
class ViewDropdownMenuComponent0 extends AppView<import1.DropdownMenuComponent> {
  ...
  ComponentRef<import1.DropdownMenuComponent> build() {
    ...
    _PopupSourceDirective_1_7 = (import12.isDevMode
        ? import14.debugInjectorWrap(import5.PopupSourceDirective, () {
            return import5.PopupSourceDirective(parentView.injectorGet(import15.DomPopupSourceFactory, viewData.parentIndex), _el_1, parentView.injectorGet(import16.ReferenceDirective, viewData.parentIndex, null), _Focusable_1_6, null);
          })
        : import5.PopupSourceDirective(parentView.injectorGet(import15.DomPopupSourceFactory, viewData.parentIndex), _el_1, parentView.injectorGet(import16.ReferenceDirective, viewData.parentIndex, null), _Focusable_1_6, null));
    final _text_2 = import2.Text('\n  ');
    ...
    _PopupSourceDirective_5_6 = (import12.isDevMode
        ? import14.debugInjectorWrap(import5.PopupSourceDirective, () {
            return import5.PopupSourceDirective(parentView.injectorGet(import15.DomPopupSourceFactory, viewData.parentIndex), _el_5, parentView.injectorGet(import16.ReferenceDirective, viewData.parentIndex, null), parentView.injectorGet(import17.Focusable, viewData.parentIndex, null), null);
          })
        : import5.PopupSourceDirective(parentView.injectorGet(import15.DomPopupSourceFactory, viewData.parentIndex), _el_5, parentView.injectorGet(import16.ReferenceDirective, viewData.parentIndex, null), parentView.injectorGet(import17.Focusable, viewData.parentIndex, null), null));
    final _text_6 = import2.Text('\n  ');
    final _text_7 = import2.Text('\n');
    _compView_5.create(_MenuPopupComponent_5_5, [
      <dynamic>[_text_6]..addAll(projectableNodes[1])..addAll([_text_7])
    ]);
    final _text_8 = import2.Text('\n');
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import18.HasDisabled) && ((1 <= nodeIndex) && (nodeIndex <= 3)))) {
      return _DropdownButtonComponent_1_5;
    }
    if ((identical(token, import17.Focusable) && ((1 <= nodeIndex) && (nodeIndex <= 3)))) {

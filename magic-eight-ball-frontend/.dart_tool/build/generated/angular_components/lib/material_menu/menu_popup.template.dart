...
import '../src/laminate/popup/popup_size_provider.dart' as import22;
...
import '../material_list/material_list.template.dart' as import28;
import '../material_list/material_list.dart' as import29;
import 'menu_item_groups.template.dart' as import30;
import '../focus/focus.dart' as import31;
import 'menu_root.dart' as import32;
import 'menu_item_groups.dart' as import33;
...
class ViewMenuPopupComponent0 extends AppView<import2.MenuPopupComponent> {
  ...
  ComponentRef<import2.MenuPopupComponent> build() {
    ...
    _MaterialPopupComponent_0_8 = (import12.isDevMode
        ? import14.debugInjectorWrap(import6.MaterialPopupComponent, () {
            return import6.MaterialPopupComponent(parentView.injectorGet(import15.PopupHierarchy, viewData.parentIndex, null), parentView.injectorGet(import6.MaterialPopupComponent, viewData.parentIndex, null), null, parentView.injectorGet(import16.NgZone, viewData.parentIndex), parentView.injectorGet(import17.OverlayService, viewData.parentIndex), parentView.injectorGet(import18.ZIndexer, viewData.parentIndex), parentView.injectorGet(const import19.OpaqueToken<List<import21.RelativePosition>>('defaultPopupPositions'), viewData.parentIndex), parentView.injectorGet(const import19.OpaqueToken<dynamic>('overlayRepositionLoop'), viewData.parentIndex), parentView.injectorGet(import22.PopupSizeProvider, viewData.parentIndex, null), _compView_0.ref, _appEl_0, ElementRef(_el_0));
          })
        : import6.MaterialPopupComponent(parentView.injectorGet(import15.PopupHierarchy, viewData.parentIndex, null), parentView.injectorGet(import6.MaterialPopupComponent, viewData.parentIndex, null), null, parentView.injectorGet(import16.NgZone, viewData.parentIndex), parentView.injectorGet(import17.OverlayService, viewData.parentIndex), parentView.injectorGet(import18.ZIndexer, viewData.parentIndex), parentView.injectorGet(const import19.OpaqueToken<List<import21.RelativePosition>>('defaultPopupPositions'), viewData.parentIndex), parentView.injectorGet(const import19.OpaqueToken<dynamic>('overlayRepositionLoop'), viewData.parentIndex), parentView.injectorGet(import22.PopupSizeProvider, viewData.parentIndex, null), _compView_0.ref, _appEl_0, ElementRef(_el_0)));
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((((identical(token, import6.MaterialPopupComponent) || identical(token, import25.DeferredContentAware)) || identical(token, import26.DropdownHandle)) && ((0 <= nodeIndex) && (nodeIndex <= 1)))) {
      return _MaterialPopupComponent_0_8;
    }
    if ((identical(token, import27.PopupRef) && ((0 <= nodeIndex) && (nodeIndex <= 1)))) {
...
class _ViewMenuPopupComponent1 extends AppView<import2.MenuPopupComponent> {
  import3.Element _el_0;
  import28.ViewMaterialListComponent0 _compView_0;
  import29.MaterialListComponent _MaterialListComponent_0_5;
  import3.Element _el_1;
  import30.ViewMenuItemGroupsComponent0 _compView_1;
  import31.AutoFocusDirective _AutoFocusDirective_1_5;
  import32.MenuRootDirective _MenuRootDirective_1_6;
  import32.MenuRootDirective _MenuRoot_1_7;
  import33.MenuItemGroupsComponent _MenuItemGroupsComponent_1_8;
  var _expr_0;
  var _expr_2;
  String _expr_3;
  ...
  @override
  ComponentRef<import2.MenuPopupComponent> build() {
    _compView_0 = import28.ViewMaterialListComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    _el_0.className = 'item-group-list';
    addShimC(_el_0);
    _MaterialListComponent_0_5 = import29.MaterialListComponent();
    _compView_1 = import30.ViewMenuItemGroupsComponent0(this, 1);
    ...
    _AutoFocusDirective_1_5 = (import12.isDevMode
        ? import14.debugInjectorWrap(import31.AutoFocusDirective, () {
            return import31.AutoFocusDirective(_el_1, parentView.parentView.injectorGet(import34.DomService, parentView.viewData.parentIndex), null, parentView.parentView.injectorGet(import35.ModalComponent, parentView.viewData.parentIndex, null), import12.unsafeCast<ViewMenuPopupComponent0>(parentView)._PopupRef_0_10);
          })
        : import31.AutoFocusDirective(_el_1, parentView.parentView.injectorGet(import34.DomService, parentView.viewData.parentIndex), null, parentView.parentView.injectorGet(import35.ModalComponent, parentView.viewData.parentIndex, null), import12.unsafeCast<ViewMenuPopupComponent0>(parentView)._PopupRef_0_10));
    _MenuRootDirective_1_6 = import32.MenuRootDirective(import12.unsafeCast<ViewMenuPopupComponent0>(parentView)._MaterialPopupComponent_0_8);
    _MenuRoot_1_7 = _MenuRootDirective_1_6;
    _MenuItemGroupsComponent_1_8 = (import12.isDevMode
        ? import14.debugInjectorWrap(import33.MenuItemGroupsComponent, () {
            return import33.MenuItemGroupsComponent(_MenuRoot_1_7, _compView_1.ref, import12.unsafeCast<ViewMenuPopupComponent0>(parentView)._MaterialPopupComponent_0_8, parentView.parentView.injectorGet(import36.IdGenerator, parentView.viewData.parentIndex, null));
          })
        : import33.MenuItemGroupsComponent(_MenuRoot_1_7, _compView_1.ref, import12.unsafeCast<ViewMenuPopupComponent0>(parentView)._MaterialPopupComponent_0_8, parentView.parentView.injectorGet(import36.IdGenerator, parentView.viewData.parentIndex, null)));
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import32.MenuRoot) && (1 == nodeIndex))) {

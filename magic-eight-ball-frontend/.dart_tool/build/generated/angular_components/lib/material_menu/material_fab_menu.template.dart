...
import '../laminate/overlay/zindexer.dart' as import32;
...
import '../src/laminate/popup/popup_size_provider.dart' as import36;
...
import '../material_list/material_list_item.template.dart' as import41;
import '../material_list/material_list_item.dart' as import42;
import 'menu_item_groups.template.dart' as import43;
import '../focus/focus.dart' as import44;
import 'menu_root.dart' as import45;
import 'menu_item_groups.dart' as import46;
...
class ViewMaterialFabMenuComponent0 extends AppView<import2.MaterialFabMenuComponent> {
    ...
    if ((this.__TooltipController_1_11 == null)) {
      (__TooltipController_1_11 = (import16.isDevMode
          ? import18.debugInjectorWrap(import19.TooltipController, () {
              return import20.createTooltipController(this.parentView.injectorGet(import19.TooltipController, this.viewData.parentIndex, null), this.parentView.injectorGet(import21.Disposer, this.viewData.parentIndex, null));
            })
          : import20.createTooltipController(this.parentView.injectorGet(import19.TooltipController, this.viewData.parentIndex, null), this.parentView.injectorGet(import21.Disposer, this.viewData.parentIndex, null))));
    }
  ...
  ComponentRef<import2.MaterialFabMenuComponent> build() {
    ...
    _MaterialTooltipDirective_1_9 = (import16.isDevMode
        ? import18.debugInjectorWrap(import7.MaterialTooltipDirective, () {
            return import7.MaterialTooltipDirective(parentView.injectorGet(import22.DomPopupSourceFactory, viewData.parentIndex), _appEl_1, _el_1, _appEl_1, _compView_1.ref, parentView.injectorGet(import3.Window, viewData.parentIndex));
          })
        : import7.MaterialTooltipDirective(parentView.injectorGet(import22.DomPopupSourceFactory, viewData.parentIndex), _appEl_1, _el_1, _appEl_1, _compView_1.ref, parentView.injectorGet(import3.Window, viewData.parentIndex)));
    _PopupSourceDirective_1_10 = (import16.isDevMode
        ? import18.debugInjectorWrap(import8.PopupSourceDirective, () {
            return import8.PopupSourceDirective(parentView.injectorGet(import22.DomPopupSourceFactory, viewData.parentIndex), _el_1, parentView.injectorGet(import23.ReferenceDirective, viewData.parentIndex, null), parentView.injectorGet(import24.Focusable, viewData.parentIndex, null), null);
          })
        : import8.PopupSourceDirective(parentView.injectorGet(import22.DomPopupSourceFactory, viewData.parentIndex), _el_1, parentView.injectorGet(import23.ReferenceDirective, viewData.parentIndex, null), parentView.injectorGet(import24.Focusable, viewData.parentIndex, null), null));
...
class _ViewMaterialFabMenuComponent1 extends AppView<import2.MaterialFabMenuComponent> {
  ...
  dynamic get _PopupRef_0_11 {
    if ((this.__PopupRef_0_11 == null)) {
      (__PopupRef_0_11 = import27.getResolvedPopupRef(this._MaterialPopupComponent_0_8));
    }
  ...
  dynamic get _PopupHierarchy_0_12 {
    if ((this.__PopupHierarchy_0_12 == null)) {
      (__PopupHierarchy_0_12 = import27.getHierarchy(this._MaterialPopupComponent_0_8));
    }
  ...
  ComponentRef<import2.MaterialFabMenuComponent> build() {
    ...
    _MaterialPopupComponent_0_8 = (import16.isDevMode
        ? import18.debugInjectorWrap(import27.MaterialPopupComponent, () {
            return import27.MaterialPopupComponent(parentView.injectorGet(import29.PopupHierarchy, viewData.parentIndex, null), parentView.injectorGet(import27.MaterialPopupComponent, viewData.parentIndex, null), null, parentView.injectorGet(import30.NgZone, viewData.parentIndex), parentView.injectorGet(import31.OverlayService, viewData.parentIndex), parentView.injectorGet(import32.ZIndexer, viewData.parentIndex), parentView.injectorGet(const import33.OpaqueToken<List<import35.RelativePosition>>('defaultPopupPositions'), viewData.parentIndex), parentView.injectorGet(const import33.OpaqueToken<dynamic>('overlayRepositionLoop'), viewData.parentIndex), parentView.injectorGet(import36.PopupSizeProvider, viewData.parentIndex, null), _compView_0.ref, _appEl_0, ElementRef(_el_0));
          })
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((((identical(token, import27.MaterialPopupComponent) || identical(token, import38.DeferredContentAware)) || identical(token, import39.DropdownHandle)) && ((0 <= nodeIndex) && (nodeIndex <= 3)))) {
      return _MaterialPopupComponent_0_8;
    }
    if ((identical(token, import40.PopupRef) && ((0 <= nodeIndex) && (nodeIndex <= 3)))) {
...
class _ViewMaterialFabMenuComponent2 extends AppView<import2.MaterialFabMenuComponent> {
  ...
  import41.ViewMaterialListItemComponent0 _compView_4;
  import42.MaterialListItemComponent _MaterialListItemComponent_4_5;
  ...
  import43.ViewMenuItemGroupsComponent0 _compView_9;
  import44.AutoFocusDirective _AutoFocusDirective_9_5;
  import45.MenuRootDirective _MenuRootDirective_9_6;
  import45.MenuRootDirective _MenuRoot_9_7;
  import46.MenuItemGroupsComponent _MenuItemGroupsComponent_9_8;
  bool _expr_0;
  bool _expr_1;
  bool _expr_2;
  bool _expr_3;
  ...
  ComponentRef<import2.MaterialFabMenuComponent> build() {
    ...
    _compView_4 = import41.ViewMaterialListItemComponent0(this, 4);
    _el_4 = _compView_4.rootEl;
    _el_2.append(_el_4);
    _el_4.className = import15.interpolate2('', 'close-menu', ' ', import42.MaterialListItemComponent.hostClass, '');
    addShimC(_el_4);
    _MaterialListItemComponent_4_5 = import42.MaterialListItemComponent(_el_4, import16.unsafeCast<_ViewMaterialFabMenuComponent1>(parentView)._MaterialPopupComponent_0_8, null, null);
    final _text_5 = import3.Text('\n        ');
    ...
    final _text_8 = import3.Text('\n      ');
    _el_2.append(_text_8);
    _compView_9 = import43.ViewMenuItemGroupsComponent0(this, 9);
    ...
    _AutoFocusDirective_9_5 = (import16.isDevMode
        ? import18.debugInjectorWrap(import44.AutoFocusDirective, () {
            return import44.AutoFocusDirective(_el_9, parentView.parentView.injectorGet(import47.DomService, parentView.viewData.parentIndex), null, parentView.parentView.injectorGet(import48.ModalComponent, parentView.viewData.parentIndex, null), import16.unsafeCast<_ViewMaterialFabMenuComponent1>(parentView)._PopupRef_0_11);
          })
        : import44.AutoFocusDirective(_el_9, parentView.parentView.injectorGet(import47.DomService, parentView.viewData.parentIndex), null, parentView.parentView.injectorGet(import48.ModalComponent, parentView.viewData.parentIndex, null), import16.unsafeCast<_ViewMaterialFabMenuComponent1>(parentView)._PopupRef_0_11));
    _MenuRootDirective_9_6 = import45.MenuRootDirective(import16.unsafeCast<_ViewMaterialFabMenuComponent1>(parentView)._MaterialPopupComponent_0_8);
    _MenuRoot_9_7 = _MenuRootDirective_9_6;
    _MenuItemGroupsComponent_9_8 = (import16.isDevMode
        ? import18.debugInjectorWrap(import46.MenuItemGroupsComponent, () {
            return import46.MenuItemGroupsComponent(_MenuRoot_9_7, _compView_9.ref, import16.unsafeCast<_ViewMaterialFabMenuComponent1>(parentView)._MaterialPopupComponent_0_8, parentView.parentView.injectorGet(import49.IdGenerator, parentView.viewData.parentIndex, null));
          })
        : import46.MenuItemGroupsComponent(_MenuRoot_9_7, _compView_9.ref, import16.unsafeCast<_ViewMaterialFabMenuComponent1>(parentView)._MaterialPopupComponent_0_8, parentView.parentView.injectorGet(import49.IdGenerator, parentView.viewData.parentIndex, null)));
    final _text_10 = import3.Text('\n      ');
    _compView_9.create(_MenuItemGroupsComponent_9_8, []);
    final _text_11 = import3.Text('\n    ');
    _el_2.append(_text_11);
    final _text_12 = import3.Text('\n  ');
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    ...
    if ((identical(token, import45.MenuRoot) && ((9 <= nodeIndex) && (nodeIndex <= 10)))) {

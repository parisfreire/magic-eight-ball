define(['dart_sdk', 'packages/angular_components/material_list/material_list_item.scss.css.shim', 'packages/angular/src/core/linker/view_type', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_components/material_list/material_list_item', 'packages/angular/src/bootstrap/modules', 'packages/angular_components/mixins/material_dropdown_base', 'packages/angular_components/interfaces/has_disabled', 'packages/angular/angular.template', 'packages/angular_components/button_decorator/button_decorator.template', 'packages/angular_components/interfaces/has_disabled.template', 'packages/angular_components/mixins/material_dropdown_base.template', 'packages/angular_components/utils/disposer/disposer.template'], function(dart_sdk, material_list_item$46scss$46css, view_type, change_detection, material_list_item, modules, material_dropdown_base, has_disabled, angular, button_decorator, has_disabled$, material_dropdown_base$, disposer) {
  ...
  material_list__material_list_item$46template._ViewMaterialListItemComponentHost0 = class _ViewMaterialListItemComponentHost0 extends src__core__linker__app_view.AppView$(material_list__material_list_item.MaterialListItemComponent) {
    build() {
      ...
      this[_MaterialListItemComponent_0_5] = dart.test(src__runtime__optimizations.isDevMode) ? src__di__errors.debugInjectorWrap(material_list__material_list_item.MaterialListItemComponent, dart.wrapType(material_list__material_list_item.MaterialListItemComponent), dart.fn(() => new material_list__material_list_item.MaterialListItemComponent.new(this.rootEl, mixins__material_dropdown_base.DropdownHandle._check(this.injectorGet(dart.wrapType(mixins__material_dropdown_base.DropdownHandle), this.viewData.parentIndex, null)), null, null), VoidToMaterialListItemComponent())) : new material_list__material_list_item.MaterialListItemComponent.new(this.rootEl, mixins__material_dropdown_base.DropdownHandle._check(this.injectorGet(dart.wrapType(mixins__material_dropdown_base.DropdownHandle), this.viewData.parentIndex, null)), null, null);
  ...
  }, '{"version":3,"sourceRoot":"","sources":["material_list_item.template.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;MAiCoB,6EAAgC;YAAG,EAAS,4DAAM;;;;;;;;;;;AAiBlE,UAAwC,OAAO,QAAG;AAClD,UAAM,UAAU,WAAM;AACtB,UAA0B,mBAAmB,iBAAY,CAAC,OAAO;AACjE,kBAAO,CAAC,gBAAgB,EAAE;AAC1B,eAAI,CAAC,uDAAU;AACf,aAAO,mBAAiB,CAAC,SAAS,kBAAa,wCAAC,IAAI;AACpD,aAAO,mBAAiB,CAAC,YAAY,kBAAa,2CAAC,IAAI;IACzD;sBAEuB,UAAe;AACpC,UAAM,YAAY,QAAG,SAAS;AAC9B,oBAAI,AAAQ,8CAAY,CAAC,aAAO,EAAE,SAAS,IAAG;AAC5C,oBAAO,CAAC,WAAM,EAAE,YAAY,SAAS;AACrC,qBAAO,GAAG,SAAS;;AAErB,UAAM,YAAY,QAAG,SAAS;AAC9B,oBAAI,AAAQ,8CAAY,CAAC,aAAO,EAAE,SAAS,IAAG;AAC5C,oBAAO,CAAC,WAAM,EAAE,QAAQ,SAAS;AACjC,qBAAO,GAAG,SAAS;;AAErB,UAAM,YAAY,QAAG,YAAY;AACjC,oBAAI,AAAQ,8CAAY,CAAC,aAAO,EAAE,SAAS,IAAG;AAC5C,oBAAO,CAAC,WAAM,EAAE,iBAAiB,SAAS;AAC1C,qBAAO,GAAG,SAAS;;AAErB,UAAM,YAAY,QAAG,SAAS;AAC9B,oBAAI,AAAQ,8CAAY,CAAC,aAAO,EAAE,SAAS,IAAG;AAC5C,4BAAe,CAAC,WAAM,EAAE,eAAe,SAAS;AAChD,qBAAO,GAAG,SAAS;;AAErB,UAAM,YAAY,QAAG,SAAS;AAC9B,oBAAI,AAAQ,8CAAY,CAAC,aAAO,EAAE,SAAS,IAAG;AAC5C,4BAAe,CAAC,WAAM,EAAE,YAAY,SAAS;AAC7C,qBAAO,GAAG,SAAS;;IAEvB;;8FA3C+B,UAA2B,EAAE,WAAe;IANvE,aAAO;IACP,aAAO;IACP,aAAO;IACN,aAAO;IACP,aAAO;AAEmE,yGAAM,qCAAgB,UAAU,EAAE,2CAAI,UAAU,EAAE,WAAW,EAAE,8DAAuB,UAAU;AAC7K,eAAM,2BAAG,AAAQ,aAAQ,gBAAc,CAAC;AACxC,eAAM,UAAU,GAAG,2DAAiC,UAAU;AAC9D,mGAAW;gBAAX,uFAAW,GAAK,AAAQ,8CAAY,iBAAiB,CAAE,UAAQ,qCAAS,IAAG,uEAAuE,MAAO,2CAAiB,SAAS,EAAE,6EAAgC;AACrN,2BAAkB,CAAC,uFAAW;EAChC;;;;;;;;;;;;;;;;MAN2B,uFAAW;;;;;iGA+C0C,UAA2B,EAAE,WAAe;AAC5H,eAAO,+EAA8B,CAAC,UAAU,EAAE,WAAW;EAC/D;;MAEoB,iFAAoC;YAAG;;;;;;;AAQvD,uBAAW,OAAG,+EAA8B,CAAC,MAAM;AACnD,iBAAM,GAAG,iBAAW,OAAO;AAC3B,0CAA8B,GAAI,UAAQ,qCAAS,IAC7C,AAAS,iCAAiB,8DAAS,0EAAyB,EAAE,kBACrD,+DAAiC,CAAC,WAAM,uDAAE,gBAAgB,CAAU,4DAAc,EAAE,aAAQ,YAAY,EAAE,QAAO,MAAM,iDAEhI,+DAAiC,CAAC,WAAM,uDAAE,gBAAgB,CAAU,4DAAc,EAAE,aAAQ,YAAY,EAAE,QAAO,MAAM;AAC7H,uBAAW,OAAO,CAAC,oCAA8B,EAAE,qBAAgB;AACnE,gBAAK,CAAC,WAAM;AACZ,iBAAO,+CAAY,CAAC,GAAG,MAAM,WAAM,EAAE,oCAA8B;IACrE;wBAG4B,KAAa,EAAE,SAAa,EAAE,cAAsB;AAC9E,UAAK,AAAU,KAAK,KAAW,mDAAW,IAAM,MAAK,SAAS,EAAI;AAChE,cAAO,qCAA8B;;AAEvC,YAAO,eAAc;IACvB;;AAIE,UAAK,UAAU;AACf,UAAK,aAAc,YAAY,KAAI;AACnC,UAAI,OAAO,EAAE;AACX,yBAAW,gBAAgB;;AAE7B,qBAAM,8CAAoB,eAAe,KAAI,UAAU,EAAG;AACxD,4CAA8B,SAAS;;AAEzC,uBAAW,kBAAkB,CAAC,UAAU;AACxC,uBAAW,cAAc;IAC3B;;AAIE,+BAAW;;AACX,0CAA8B,YAAY;IAC5C;;mGAzCoC,UAA2B,EAAE,WAAe;IAFjD,iBAAW;IACR,oCAA8B;AACoB,8GAAM,qCAAgB,KAAK,EAAE,2CAAI,UAAU,EAAE,WAAW,EAAE,8DAAuB,YAAY;EAAC;;;;;;;;;;;;;;qGA4C9F,UAA2B,EAAE,WAAe;AAChI,eAAO,oFAAmC,CAAC,UAAU,EAAE,WAAW;EACpE;;MAE0D,gFAAmC;YAAG,gBAAM,mDAAgB,CAAC,sBAAsB,qJAA0C;;;;;AAErL,YAAO,iFAAmC;IAC5C;;;MAEI,qDAAQ;YAAG;;;;;AAEb,kBAAI,qDAAQ,GAAE;AACZ;;AAEF,4DAAW;AAEX,IAAO,oCAAiB,CAAC,0EAAyB,EAAE,+EAAkC;AACtF,IAAM,gCAAa;AACnB,IAAM,2DAAa;AACnB,IAAM,iDAAa;AACnB,IAAM,uDAAa;AACnB,IAAM,kDAAa;EACrB","file":"material_list_item.template.ddc.js"}');
  // Exports:
  return {

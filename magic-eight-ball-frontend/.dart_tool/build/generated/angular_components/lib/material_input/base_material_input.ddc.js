define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer', 'packages/quiver/strings', 'packages/intl/intl', 'packages/angular_components/mixins/focusable_mixin', 'packages/angular_components/interfaces/has_disabled', 'packages/angular_components/focus/focus_interface', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular_forms/src/directives', 'packages/angular/src/bootstrap/modules'], function(dart_sdk, disposer, strings, intl, focusable_mixin, has_disabled, focus_interface, change_detection, directives, modules) {
  'use strict';
  ...
  material_input__base_material_input.BaseMaterialInput = class BaseMaterialInput extends mixins__focusable_mixin.FocusableMixin {
    ...
    static _msgCharacterCounter(currentCount, maxCount) {
      return intl$.Intl.message(dart.str(currentCount) + " / " + dart.str(maxCount), {name: "BaseMaterialInput__msgCharacterCounter", args: [currentCount, maxCount], desc: "Character counter shown below a text box in the format \"12 / 25\"", examples: const$ || (const$ = dart.constMap(core.String, dart.dynamic, ["currentCount", 12, "maxCount", 25]))});
    }
  };
  (material_input__base_material_input.BaseMaterialInput.new = function(cd, changeDetector, validator) {
  ...
  material_input__base_material_input.BaseMaterialInput[dart.implements] = () => [interfaces__has_disabled.HasDisabled, focus__focus_interface.Focusable, src__core__metadata__lifecycle_hooks.AfterViewInit, src__core__metadata__lifecycle_hooks.OnDestroy];
  ...
  dart.setGetterSignature(material_input__base_material_input.BaseMaterialInput, () => ({
    ...
    error: core.String,
    hintText: core.String,
    requiredErrorMsg: core.String,
    checkValid: dart.fnType(core.String, [core.String]),
    inputTextLength: core.int,
    inputText: core.String,
    disabled: core.bool,
    showHintOnlyOnFocus: core.bool,
    required: core.bool,
    onKeypress: async.Stream$(core.String),
    onChange: async.Stream$(core.String),
    onBlur: async.Stream$(html.FocusEvent),
    underlineAnimated: core.bool,
    floatingLabelVisible: core.bool,
    labelAnimated: core.bool,
    labelAnimationReset: core.bool,
    invalid: core.bool,
    hasVisibleText: core.bool,
    labelVisible: core.bool,
    ariaLabel: core.String,
    errorMessage: core.String,
    inputRef: src__core__linker__element_ref.ElementRef
  }));
  dart.setSetterSignature(material_input__base_material_input.BaseMaterialInput, () => ({
    ...
    checkValid: dart.fnType(core.String, [core.String]),
    inputText: core.String,
    characterCounter: dart.fnType(core.int, [core.String]),
    disabled: core.bool,
    showHintOnlyOnFocus: core.bool,
    required: core.bool
  }));
  ...
  dart.defineLazy(material_input__base_material_input.BaseMaterialInput, {
    /*material_input__base_material_input.BaseMaterialInput.defaultEmptyMessage*/get defaultEmptyMessage() {

...
import '../utils/browser/dom_service/dom_service.dart' as import35;
...
class ViewMaterialAutoSuggestInputComponent0<T> extends AppView<import3.MaterialAutoSuggestInputComponent<T>> {
  ...
  import8.MaterialInputComponent _Focusable_0_13;
  import10.PopupSourceDirective _PopupSourceDirective_0_14;
  ...
  dynamic get _PopupRef_3_11 {
    if ((this.__PopupRef_3_11 == null)) {
      (__PopupRef_3_11 = import14.getResolvedPopupRef(this._MaterialPopupComponent_3_8));
    }
  ...
  dynamic get _PopupHierarchy_3_12 {
    if ((this.__PopupHierarchy_3_12 == null)) {
      (__PopupHierarchy_3_12 = import14.getHierarchy(this._MaterialPopupComponent_3_8));
    }
  ...
  ComponentRef<import3.MaterialAutoSuggestInputComponent<T>> build() {
    ...
    _compView_0 = import5.ViewMaterialInputComponent0(this, 0);
    ...
    addShimC(_el_0);
    _DeferredValidator_0_5 = import6.DeferredValidator();
    _NgValidators_0_6 = [_DeferredValidator_0_5];
    _NgModel_0_7 = import7.NgModel(_NgValidators_0_6, null);
    _NgControl_0_8 = _NgModel_0_7;
    _MaterialInputComponent_0_9 = import8.MaterialInputComponent(null, null, 'combobox', _NgControl_0_8, _compView_0.ref, _DeferredValidator_0_5);
    _BaseMaterialInput_0_10 = _MaterialInputComponent_0_9;
    _MaterialInputDefaultValueAccessor_0_11 = import9.MaterialInputDefaultValueAccessor(_BaseMaterialInput_0_10, _NgControl_0_8);
    ...
    _PopupSourceDirective_0_14 = (import21.isDevMode
        ? import23.debugInjectorWrap(import10.PopupSourceDirective, () {
            return import10.PopupSourceDirective(parentView.injectorGet(import24.DomPopupSourceFactory, viewData.parentIndex), _el_0, _ReferenceDirective_0_12, _Focusable_0_13, 'false');
          })
        : import10.PopupSourceDirective(parentView.injectorGet(import24.DomPopupSourceFactory, viewData.parentIndex), _el_0, _ReferenceDirective_0_12, _Focusable_0_13, 'false'));
    ...
    _compView_3 = import13.ViewMaterialPopupComponent0(this, 3);
    ...
    _MaterialPopupComponent_3_8 = (import21.isDevMode
        ? import23.debugInjectorWrap(import14.MaterialPopupComponent, () {
            return import14.MaterialPopupComponent(parentView.injectorGet(import26.PopupHierarchy, viewData.parentIndex, null), parentView.injectorGet(import14.MaterialPopupComponent, viewData.parentIndex, null), null, parentView.injectorGet(import27.NgZone, viewData.parentIndex), parentView.injectorGet(import28.OverlayService, viewData.parentIndex), parentView.injectorGet(import29.ZIndexer, viewData.parentIndex), parentView.injectorGet(const import30.OpaqueToken<List<import32.RelativePosition>>('defaultPopupPositions'), viewData.parentIndex), parentView.injectorGet(const import30.OpaqueToken<dynamic>('overlayRepositionLoop'), viewData.parentIndex), parentView.injectorGet(import33.PopupSizeProvider, viewData.parentIndex, null), _compView_3.ref, _appEl_3, ElementRef(_el_3));
          })
        : import14.MaterialPopupComponent(parentView.injectorGet(import26.PopupHierarchy, viewData.parentIndex, null), parentView.injectorGet(import14.MaterialPopupComponent, viewData.parentIndex, null), null, parentView.injectorGet(import27.NgZone, viewData.parentIndex), parentView.injectorGet(import28.OverlayService, viewData.parentIndex), parentView.injectorGet(import29.ZIndexer, viewData.parentIndex), parentView.injectorGet(const import30.OpaqueToken<List<import32.RelativePosition>>('defaultPopupPositions'), viewData.parentIndex), parentView.injectorGet(const import30.OpaqueToken<dynamic>('overlayRepositionLoop'), viewData.parentIndex), parentView.injectorGet(import33.PopupSizeProvider, viewData.parentIndex, null), _compView_3.ref, _appEl_3, ElementRef(_el_3)));
    ...
    _KeyboardOnlyFocusIndicatorDirective_4_5 = (import21.isDevMode
        ? import23.debugInjectorWrap(import15.KeyboardOnlyFocusIndicatorDirective, () {
            return import15.KeyboardOnlyFocusIndicatorDirective(_el_4, parentView.injectorGet(import35.DomService, viewData.parentIndex));
          })
        : import15.KeyboardOnlyFocusIndicatorDirective(_el_4, parentView.injectorGet(import35.DomService, viewData.parentIndex)));
    project(_el_4, 1);
    ...
    _CachingDeferredContentDirective_5_9 = import16.CachingDeferredContentDirective(_appEl_5, _TemplateRef_5_8, _MaterialPopupComponent_3_8);
    ...
    _KeyboardOnlyFocusIndicatorDirective_6_5 = (import21.isDevMode
        ? import23.debugInjectorWrap(import15.KeyboardOnlyFocusIndicatorDirective, () {
            return import15.KeyboardOnlyFocusIndicatorDirective(_el_6, parentView.injectorGet(import35.DomService, viewData.parentIndex));
          })
        : import15.KeyboardOnlyFocusIndicatorDirective(_el_6, parentView.injectorGet(import35.DomService, viewData.parentIndex)));
    project(_el_6, 2);
    ...
    _el_6.addEventListener('keyup', eventHandler1(_handle_keyup_6_0));
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    ...
    if ((identical(token, const import30.MultiToken<dynamic>('NgValidators')) && ((0 <= nodeIndex) && (nodeIndex <= 2)))) {
    ...
    if (((identical(token, import8.MaterialInputComponent) || identical(token, import37.HasDisabled)) && ((0 <= nodeIndex) && (nodeIndex <= 2)))) {
    ...
    if ((((identical(token, import14.MaterialPopupComponent) || identical(token, import41.DeferredContentAware)) || identical(token, import42.DropdownHandle)) && ((3 <= nodeIndex) && (nodeIndex <= 6)))) {
  ...
  void detectChangesInternal() {
    ...
    final import10.PopupSourceDirective local_input = _PopupSourceDirective_0_14;
    changed = false;
  ...
  void _handle_keyup_4_0($event) {
    ctx.onKeyUp($event);
    _KeyboardOnlyFocusIndicatorDirective_4_5.resetOutline();
  }

  void _handle_keyup_6_0($event) {
    ctx.onKeyUp($event);
    _KeyboardOnlyFocusIndicatorDirective_6_5.resetOutline();
  }
}
...
class _ViewMaterialAutoSuggestInputComponent1<T> extends AppView<import3.MaterialAutoSuggestInputComponent<T>> {
    ...
    if ((this.__TooltipController_0_13 == null)) {
      (__TooltipController_0_13 = (import21.isDevMode
          ? import23.debugInjectorWrap(import49.TooltipController, () {
              return import50.createTooltipController(this.parentView.parentView.injectorGet(import49.TooltipController, this.parentView.viewData.parentIndex, null), this.parentView.parentView.injectorGet(import51.Disposer, this.parentView.viewData.parentIndex, null));
            })
          : import50.createTooltipController(this.parentView.parentView.injectorGet(import49.TooltipController, this.parentView.viewData.parentIndex, null), this.parentView.parentView.injectorGet(import51.Disposer, this.parentView.viewData.parentIndex, null))));
    }
  ...
  ComponentRef<import3.MaterialAutoSuggestInputComponent<T>> build() {
    ...
    _KeyboardOnlyFocusIndicatorDirective_0_9 = (import21.isDevMode
        ? import23.debugInjectorWrap(import15.KeyboardOnlyFocusIndicatorDirective, () {
            return import15.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.injectorGet(import35.DomService, parentView.viewData.parentIndex));
          })
        : import15.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.injectorGet(import35.DomService, parentView.viewData.parentIndex)));
    ...
    _MaterialTooltipDirective_0_11 = (import21.isDevMode
        ? import23.debugInjectorWrap(import47.MaterialTooltipDirective, () {
            return import47.MaterialTooltipDirective(parentView.parentView.injectorGet(import24.DomPopupSourceFactory, parentView.viewData.parentIndex), _appEl_0, _el_0, _appEl_0, _compView_0.ref, parentView.parentView.injectorGet(import4.Window, parentView.viewData.parentIndex));
          })
        : import47.MaterialTooltipDirective(parentView.parentView.injectorGet(import24.DomPopupSourceFactory, parentView.viewData.parentIndex), _appEl_0, _el_0, _appEl_0, _compView_0.ref, parentView.parentView.injectorGet(import4.Window, parentView.viewData.parentIndex)));
...
class _ViewMaterialAutoSuggestInputComponent5<T> extends AppView<import3.MaterialAutoSuggestInputComponent<T>> {
  ...
  ComponentRef<import3.MaterialAutoSuggestInputComponent<T>> build() {
    ...
    _KeyboardOnlyFocusIndicatorDirective_0_5 = (import21.isDevMode
        ? import23.debugInjectorWrap(import15.KeyboardOnlyFocusIndicatorDirective, () {
            return import15.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.parentView.injectorGet(import35.DomService, parentView.parentView.viewData.parentIndex));
          })
        : import15.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.parentView.injectorGet(import35.DomService, parentView.parentView.viewData.parentIndex)));
...
class _ViewMaterialAutoSuggestInputComponent9<T> extends AppView<import3.MaterialAutoSuggestInputComponent<T>> {
  ...
  ComponentRef<import3.MaterialAutoSuggestInputComponent<T>> build() {
    ...
    _KeyboardOnlyFocusIndicatorDirective_0_5 = (import21.isDevMode
        ? import23.debugInjectorWrap(import15.KeyboardOnlyFocusIndicatorDirective, () {
            return import15.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.parentView.parentView.parentView.injectorGet(import35.DomService, parentView.parentView.parentView.parentView.viewData.parentIndex));
          })
        : import15.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.parentView.parentView.parentView.injectorGet(import35.DomService, parentView.parentView.parentView.parentView.viewData.parentIndex)));
  ...
  ComponentRef<import3.MaterialAutoSuggestInputComponent<T>> build() {
    ...
    _ActiveItemDirective_0_5 = import70.ActiveItemDirectiveNgCd((import21.isDevMode
        ? import23.debugInjectorWrap(import71.ActiveItemDirective, () {
            return import71.ActiveItemDirective(_el_0, parentView.parentView.parentView.parentView.parentView.injectorGet(import35.DomService, parentView.parentView.parentView.parentView.viewData.parentIndex), parentView.parentView.parentView.parentView.parentView.injectorGet(import72.Modal, parentView.parentView.parentView.parentView.viewData.parentIndex, null), import21.unsafeCast<ViewMaterialAutoSuggestInputComponent0>(parentView.parentView.parentView.parentView)._PopupRef_3_11);
          })
        : import71.ActiveItemDirective(_el_0, parentView.parentView.parentView.parentView.parentView.injectorGet(import35.DomService, parentView.parentView.parentView.parentView.viewData.parentIndex), parentView.parentView.parentView.parentView.parentView.injectorGet(import72.Modal, parentView.parentView.parentView.parentView.viewData.parentIndex, null), import21.unsafeCast<ViewMaterialAutoSuggestInputComponent0>(parentView.parentView.parentView.parentView)._PopupRef_3_11)));
  ...
  ComponentRef<import3.MaterialAutoSuggestInputComponent<T>> build() {
    ...
    _MaterialAutoSuggestInputComponent_0_5 = (import21.isDevMode
        ? import23.debugInjectorWrap(import3.MaterialAutoSuggestInputComponent, () {
            return import3.MaterialAutoSuggestInputComponent(null, this.injectorGet(import67.IdGenerator, viewData.parentIndex, null), this.injectorGet(import33.PopupSizeProvider, viewData.parentIndex, null));
          })
        : import3.MaterialAutoSuggestInputComponent(null, this.injectorGet(import67.IdGenerator, viewData.parentIndex, null), this.injectorGet(import33.PopupSizeProvider, viewData.parentIndex, null)));

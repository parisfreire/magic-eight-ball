...
import '../../../dynamic_component/dynamic_component.template.dart' as import14;
...
import '../../../material_radio/material_radio_group.template.dart' as import20;
import '../../../material_radio/material_radio_group.dart' as import21;
import 'package:angular/src/core/zone/ng_zone.dart' as import22;
import '../../../material_radio/material_radio.template.dart' as import23;
...
import '../../../material_checkbox/material_checkbox.template.dart' as import28;
...
class ViewMaterialTreeGroupFlatListComponent0 extends AppView<import2.MaterialTreeGroupFlatListComponent> {
  ...
  ViewMaterialTreeGroupFlatListComponent0(AppView<dynamic> parentView, int parentIndex) : super(import6.ViewType.component, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
    ...
    _renderType ??= import9.appViewUtils.createRenderType((import10.isDevMode ? 'asset:angular_components/lib/src/material_tree/group/material_tree_group_flat.dart' : null), ViewEncapsulation.Emulated, styles$MaterialTreeGroupFlatListComponent);
  ...
  ComponentRef<import2.MaterialTreeGroupFlatListComponent> build() {
    ...
    TemplateRef _TemplateRef_0_8 = TemplateRef(_appEl_0, viewFactory_MaterialTreeGroupFlatListComponent1);
...
AppView<import2.MaterialTreeGroupFlatListComponent> viewFactory_MaterialTreeGroupFlatListComponent0(AppView<dynamic> parentView, int parentIndex) {
  return ViewMaterialTreeGroupFlatListComponent0(parentView, parentIndex);
}
...
class _ViewMaterialTreeGroupFlatListComponent1 extends AppView<import2.MaterialTreeGroupFlatListComponent> {
  ...
  ComponentRef<import2.MaterialTreeGroupFlatListComponent> build() {
    ...
    TemplateRef _TemplateRef_1_8 = TemplateRef(_appEl_1, viewFactory_MaterialTreeGroupFlatListComponent2);
    _NgIf_1_9 = NgIf(_appEl_1, _TemplateRef_1_8);
    final _anchor_2 = createViewContainerAnchor();
    _el_0.append(_anchor_2);
    _appEl_2 = ViewContainer(2, 0, this, _anchor_2);
    TemplateRef _TemplateRef_2_8 = TemplateRef(_appEl_2, viewFactory_MaterialTreeGroupFlatListComponent3);
...
AppView<import2.MaterialTreeGroupFlatListComponent> viewFactory_MaterialTreeGroupFlatListComponent1(AppView<dynamic> parentView, int parentIndex) {
  return _ViewMaterialTreeGroupFlatListComponent1(parentView, parentIndex);
}

class _ViewMaterialTreeGroupFlatListComponent2 extends AppView<import2.MaterialTreeGroupFlatListComponent> {
  import8.Element _el_0;
  import14.ViewDynamicComponent0 _compView_0;
  ViewContainer _appEl_0;
  import15.DynamicComponent _DynamicComponent_0_8;
  var _expr_0;
  var _expr_1;
  var _expr_2;
  ...
  @override
  ComponentRef<import2.MaterialTreeGroupFlatListComponent> build() {
    _compView_0 = import14.ViewDynamicComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    _el_0.className = 'item component';
    addShimC(_el_0);
    _appEl_0 = ViewContainer(0, null, this, _el_0);
    _DynamicComponent_0_8 = (import10.isDevMode
        ? import16.debugInjectorWrap(import15.DynamicComponent, () {
            return import15.DynamicComponent(parentView.parentView.injectorGet(import17.SlowComponentLoader, parentView.viewData.parentIndex), _compView_0.ref, _appEl_0);
          })
        : import15.DynamicComponent(parentView.parentView.injectorGet(import17.SlowComponentLoader, parentView.viewData.parentIndex), _compView_0.ref, _appEl_0));
...
AppView<import2.MaterialTreeGroupFlatListComponent> viewFactory_MaterialTreeGroupFlatListComponent2(AppView<dynamic> parentView, int parentIndex) {
  return _ViewMaterialTreeGroupFlatListComponent2(parentView, parentIndex);
}
...
AppView<import2.MaterialTreeGroupFlatListComponent> viewFactory_MaterialTreeGroupFlatListComponent3(AppView<dynamic> parentView, int parentIndex) {
  return _ViewMaterialTreeGroupFlatListComponent3(parentView, parentIndex);
}

final List<dynamic> styles$MaterialTreeGroupFlatListComponentHost = const [];

class _ViewMaterialTreeGroupFlatListComponentHost0 extends AppView<import2.MaterialTreeGroupFlatListComponent> {
  ...
  ComponentRef<import2.MaterialTreeGroupFlatListComponent> build() {
    ...
    _MaterialTreeGroupFlatListComponent_0_5 = (import10.isDevMode
        ? import16.debugInjectorWrap(import2.MaterialTreeGroupFlatListComponent, () {
            return import2.MaterialTreeGroupFlatListComponent(this.injectorGet(import18.MaterialTreeRoot, viewData.parentIndex), _compView_0.ref);
          })
        : import2.MaterialTreeGroupFlatListComponent(this.injectorGet(import18.MaterialTreeRoot, viewData.parentIndex), _compView_0.ref));
...
AppView<import2.MaterialTreeGroupFlatListComponent> viewFactory_MaterialTreeGroupFlatListComponentHost0(AppView<dynamic> parentView, int parentIndex) {
...
final List<dynamic> styles$MaterialTreeGroupFlatRadioComponent = [import19.styles];

class ViewMaterialTreeGroupFlatRadioComponent0 extends AppView<import2.MaterialTreeGroupFlatRadioComponent> {
  import8.Element _el_0;
  import20.ViewMaterialRadioGroupComponent0 _compView_0;
  import21.MaterialRadioGroupComponent _MaterialRadioGroupComponent_0_5;
  ViewContainer _appEl_1;
  ...
  ViewMaterialTreeGroupFlatRadioComponent0(AppView<dynamic> parentView, int parentIndex) : super(import6.ViewType.component, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
    ...
    _renderType ??= import9.appViewUtils.createRenderType((import10.isDevMode ? 'asset:angular_components/lib/src/material_tree/group/material_tree_group_flat.dart' : null), ViewEncapsulation.Emulated, styles$MaterialTreeGroupFlatRadioComponent);
    setupComponentType(_renderType);
  }
  @override
  ComponentRef<import2.MaterialTreeGroupFlatRadioComponent> build() {
    final _rootEl = rootEl;
    final import8.HtmlElement parentRenderNode = initViewRoot(_rootEl);
    _compView_0 = import20.ViewMaterialRadioGroupComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    parentRenderNode.append(_el_0);
    addShimC(_el_0);
    _MaterialRadioGroupComponent_0_5 = (import10.isDevMode
        ? import16.debugInjectorWrap(import21.MaterialRadioGroupComponent, () {
            return import21.MaterialRadioGroupComponent(parentView.injectorGet(import22.NgZone, viewData.parentIndex), null);
          })
        : import21.MaterialRadioGroupComponent(parentView.injectorGet(import22.NgZone, viewData.parentIndex), null));
    final _anchor_1 = createViewContainerAnchor();
    _appEl_1 = ViewContainer(1, 0, this, _anchor_1);
    TemplateRef _TemplateRef_1_8 = TemplateRef(_appEl_1, viewFactory_MaterialTreeGroupFlatRadioComponent1);
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import21.MaterialRadioGroupComponent) && ((0 <= nodeIndex) && (nodeIndex <= 1)))) {
...
AppView<import2.MaterialTreeGroupFlatRadioComponent> viewFactory_MaterialTreeGroupFlatRadioComponent0(AppView<dynamic> parentView, int parentIndex) {
  return ViewMaterialTreeGroupFlatRadioComponent0(parentView, parentIndex);
}
...
class _ViewMaterialTreeGroupFlatRadioComponent1 extends AppView<import2.MaterialTreeGroupFlatRadioComponent> {
  ...
  import24.MaterialRadioComponent _MaterialRadioComponent_0_5;
  ViewContainer _appEl_1;
  NgIf _NgIf_1_9;
  ViewContainer _appEl_2;
  NgIf _NgIf_2_9;
  ...
  @override
  ComponentRef<import2.MaterialTreeGroupFlatRadioComponent> build() {
    _compView_0 = import23.ViewMaterialRadioComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    _el_0.className = import9.interpolate2('', 'material-tree-option tree-selection-state', ' ', import24.MaterialRadioComponent.hostClass, '');
    createAttr(_el_0, 'role', 'option');
    addShimC(_el_0);
    _MaterialRadioComponent_0_5 = import24.MaterialRadioComponent(_el_0, _compView_0.ref, import10.unsafeCast<ViewMaterialTreeGroupFlatRadioComponent0>(parentView)._MaterialRadioGroupComponent_0_5, null, 'option');
    final _anchor_1 = createViewContainerAnchor();
    _appEl_1 = ViewContainer(1, 0, this, _anchor_1);
    TemplateRef _TemplateRef_1_8 = TemplateRef(_appEl_1, viewFactory_MaterialTreeGroupFlatRadioComponent2);
    _NgIf_1_9 = NgIf(_appEl_1, _TemplateRef_1_8);
    final _anchor_2 = createViewContainerAnchor();
    _appEl_2 = ViewContainer(2, 0, this, _anchor_2);
    TemplateRef _TemplateRef_2_8 = TemplateRef(_appEl_2, viewFactory_MaterialTreeGroupFlatRadioComponent3);
    _NgIf_2_9 = NgIf(_appEl_2, _TemplateRef_2_8);
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import25.HasDisabled) && ((0 <= nodeIndex) && (nodeIndex <= 2)))) {
  ...
  void dirtyParentQueriesInternal() {
    import10.unsafeCast<ViewMaterialTreeGroupFlatRadioComponent0>(parentView)._query_MaterialRadioComponent_0_0_isDirty = true;
  }
...
AppView<import2.MaterialTreeGroupFlatRadioComponent> viewFactory_MaterialTreeGroupFlatRadioComponent1(AppView<dynamic> parentView, int parentIndex) {
  return _ViewMaterialTreeGroupFlatRadioComponent1(parentView, parentIndex);
}
...
class _ViewMaterialTreeGroupFlatRadioComponent2 extends AppView<import2.MaterialTreeGroupFlatRadioComponent> {
  ...
  ComponentRef<import2.MaterialTreeGroupFlatRadioComponent> build() {
    ...
    _DynamicComponent_0_8 = (import10.isDevMode
        ? import16.debugInjectorWrap(import15.DynamicComponent, () {
            return import15.DynamicComponent(parentView.parentView.parentView.injectorGet(import17.SlowComponentLoader, parentView.parentView.viewData.parentIndex), _compView_0.ref, _appEl_0);
          })
        : import15.DynamicComponent(parentView.parentView.parentView.injectorGet(import17.SlowComponentLoader, parentView.parentView.viewData.parentIndex), _compView_0.ref, _appEl_0));
    _compView_0.create(_DynamicComponent_0_8, []);
    init0(_appEl_0);
  }
...
AppView<import2.MaterialTreeGroupFlatRadioComponent> viewFactory_MaterialTreeGroupFlatRadioComponent2(AppView<dynamic> parentView, int parentIndex) {
  return _ViewMaterialTreeGroupFlatRadioComponent2(parentView, parentIndex);
}
...
AppView<import2.MaterialTreeGroupFlatRadioComponent> viewFactory_MaterialTreeGroupFlatRadioComponent3(AppView<dynamic> parentView, int parentIndex) {
  return _ViewMaterialTreeGroupFlatRadioComponent3(parentView, parentIndex);
}

final List<dynamic> styles$MaterialTreeGroupFlatRadioComponentHost = const [];

class _ViewMaterialTreeGroupFlatRadioComponentHost0 extends AppView<import2.MaterialTreeGroupFlatRadioComponent> {
  ...
  ComponentRef<import2.MaterialTreeGroupFlatRadioComponent> build() {
    ...
    rootEl = _compView_0.rootEl;
    _MaterialTreeGroupFlatRadioComponent_0_5 = (import10.isDevMode
        ? import16.debugInjectorWrap(import2.MaterialTreeGroupFlatRadioComponent, () {
            return import2.MaterialTreeGroupFlatRadioComponent(this.injectorGet(import18.MaterialTreeRoot, viewData.parentIndex), _compView_0.ref, this.injectorGet(import26.DropdownHandle, viewData.parentIndex, null));
          })
        : import2.MaterialTreeGroupFlatRadioComponent(this.injectorGet(import18.MaterialTreeRoot, viewData.parentIndex), _compView_0.ref, this.injectorGet(import26.DropdownHandle, viewData.parentIndex, null)));
...
AppView<import2.MaterialTreeGroupFlatRadioComponent> viewFactory_MaterialTreeGroupFlatRadioComponentHost0(AppView<dynamic> parentView, int parentIndex) {
...
final List<dynamic> styles$MaterialTreeGroupFlatCheckComponent = [import27.styles];
...
class ViewMaterialTreeGroupFlatCheckComponent0 extends AppView<import2.MaterialTreeGroupFlatCheckComponent> {
  ...
  ViewMaterialTreeGroupFlatCheckComponent0(AppView<dynamic> parentView, int parentIndex) : super(import6.ViewType.component, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
    ...
    _renderType ??= import9.appViewUtils.createRenderType((import10.isDevMode ? 'asset:angular_components/lib/src/material_tree/group/material_tree_group_flat.dart' : null), ViewEncapsulation.Emulated, styles$MaterialTreeGroupFlatCheckComponent);
    setupComponentType(_renderType);
  }
  @override
  ComponentRef<import2.MaterialTreeGroupFlatCheckComponent> build() {
    ...
    parentRenderNode.append(_anchor_0);
    _appEl_0 = ViewContainer(0, null, this, _anchor_0);
    TemplateRef _TemplateRef_0_8 = TemplateRef(_appEl_0, viewFactory_MaterialTreeGroupFlatCheckComponent1);
    _NgFor_0_9 = import4.NgFor(_appEl_0, _TemplateRef_0_8);
    init(const [], null);
  }
...
AppView<import2.MaterialTreeGroupFlatCheckComponent> viewFactory_MaterialTreeGroupFlatCheckComponent0(AppView<dynamic> parentView, int parentIndex) {
  return ViewMaterialTreeGroupFlatCheckComponent0(parentView, parentIndex);
}

class _ViewMaterialTreeGroupFlatCheckComponent1 extends AppView<import2.MaterialTreeGroupFlatCheckComponent> {
  import8.Element _el_0;
  import28.ViewMaterialCheckboxComponent0 _compView_0;
  import29.MaterialCheckboxComponent _MaterialCheckboxComponent_0_5;
  ViewContainer _appEl_1;
  NgIf _NgIf_1_9;
  ViewContainer _appEl_2;
  NgIf _NgIf_2_9;
  ...
  @override
  ComponentRef<import2.MaterialTreeGroupFlatCheckComponent> build() {
    _compView_0 = import28.ViewMaterialCheckboxComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    _el_0.className = import9.interpolate2('', 'material-tree-option tree-selection-state', ' ', import29.MaterialCheckboxComponent.hostClass, '');
    createAttr(_el_0, 'role', 'option');
    addShimC(_el_0);
    _MaterialCheckboxComponent_0_5 = import29.MaterialCheckboxComponent(_el_0, _compView_0.ref, null, null, 'option');
    final _anchor_1 = createViewContainerAnchor();
    _appEl_1 = ViewContainer(1, 0, this, _anchor_1);
    TemplateRef _TemplateRef_1_8 = TemplateRef(_appEl_1, viewFactory_MaterialTreeGroupFlatCheckComponent2);
    _NgIf_1_9 = NgIf(_appEl_1, _TemplateRef_1_8);
    final _anchor_2 = createViewContainerAnchor();
    _appEl_2 = ViewContainer(2, 0, this, _anchor_2);
    TemplateRef _TemplateRef_2_8 = TemplateRef(_appEl_2, viewFactory_MaterialTreeGroupFlatCheckComponent3);
    _NgIf_2_9 = NgIf(_appEl_2, _TemplateRef_2_8);
...
AppView<import2.MaterialTreeGroupFlatCheckComponent> viewFactory_MaterialTreeGroupFlatCheckComponent1(AppView<dynamic> parentView, int parentIndex) {
  return _ViewMaterialTreeGroupFlatCheckComponent1(parentView, parentIndex);
}
...
AppView<import2.MaterialTreeGroupFlatCheckComponent> viewFactory_MaterialTreeGroupFlatCheckComponent2(AppView<dynamic> parentView, int parentIndex) {
  return _ViewMaterialTreeGroupFlatCheckComponent2(parentView, parentIndex);
}
...
AppView<import2.MaterialTreeGroupFlatCheckComponent> viewFactory_MaterialTreeGroupFlatCheckComponent3(AppView<dynamic> parentView, int parentIndex) {
  return _ViewMaterialTreeGroupFlatCheckComponent3(parentView, parentIndex);
}

final List<dynamic> styles$MaterialTreeGroupFlatCheckComponentHost = const [];

class _ViewMaterialTreeGroupFlatCheckComponentHost0 extends AppView<import2.MaterialTreeGroupFlatCheckComponent> {
  ...
  ComponentRef<import2.MaterialTreeGroupFlatCheckComponent> build() {
    ...
    rootEl = _compView_0.rootEl;
    _MaterialTreeGroupFlatCheckComponent_0_5 = (import10.isDevMode
        ? import16.debugInjectorWrap(import2.MaterialTreeGroupFlatCheckComponent, () {
            return import2.MaterialTreeGroupFlatCheckComponent(this.injectorGet(import18.MaterialTreeRoot, viewData.parentIndex), _compView_0.ref, this.injectorGet(import26.DropdownHandle, viewData.parentIndex, null));
          })
        : import2.MaterialTreeGroupFlatCheckComponent(this.injectorGet(import18.MaterialTreeRoot, viewData.parentIndex), _compView_0.ref, this.injectorGet(import26.DropdownHandle, viewData.parentIndex, null)));
...
AppView<import2.MaterialTreeGroupFlatCheckComponent> viewFactory_MaterialTreeGroupFlatCheckComponentHost0(AppView<dynamic> parentView, int parentIndex) {

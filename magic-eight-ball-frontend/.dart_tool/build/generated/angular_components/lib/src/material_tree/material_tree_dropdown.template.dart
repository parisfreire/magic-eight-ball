...
import 'package:angular_components/utils/browser/dom_service/dom_service.template.dart' as _ref17;
...
import '../../material_icon/material_icon.template.dart' as import35;
import '../../material_icon/material_icon.dart' as import36;
import 'material_tree_filter.template.dart' as import37;
import 'material_tree_filter.dart' as import38;
import 'material_tree_root.dart' as import39;
import 'material_tree_impl.template.dart' as import40;
import 'material_tree_impl.dart' as import41;
...
class ViewMaterialTreeDropdownComponent0 extends AppView<import2.MaterialTreeDropdownComponent> {
  ...
  ViewMaterialTreeDropdownComponent0(AppView<dynamic> parentView, int parentIndex) : super(import12.ViewType.component, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
    ...
    _renderType ??= import14.appViewUtils.createRenderType((import15.isDevMode ? 'asset:angular_components/lib/src/material_tree/material_tree_dropdown.dart' : null), ViewEncapsulation.Emulated, styles$MaterialTreeDropdownComponent);
  ...
  ComponentRef<import2.MaterialTreeDropdownComponent> build() {
    ...
    _KeyboardOnlyFocusIndicatorDirective_0_5 = (import15.isDevMode
        ? import17.debugInjectorWrap(import4.KeyboardOnlyFocusIndicatorDirective, () {
            return import4.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.injectorGet(import18.DomService, viewData.parentIndex));
          })
        : import4.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.injectorGet(import18.DomService, viewData.parentIndex)));
    _PopupSourceDirective_0_6 = (import15.isDevMode
        ? import17.debugInjectorWrap(import5.PopupSourceDirective, () {
            return import5.PopupSourceDirective(parentView.injectorGet(import19.DomPopupSourceFactory, viewData.parentIndex), _el_0, parentView.injectorGet(import20.ReferenceDirective, viewData.parentIndex, null), parentView.injectorGet(import21.Focusable, viewData.parentIndex, null), null);
          })
        : import5.PopupSourceDirective(parentView.injectorGet(import19.DomPopupSourceFactory, viewData.parentIndex), _el_0, parentView.injectorGet(import20.ReferenceDirective, viewData.parentIndex, null), parentView.injectorGet(import21.Focusable, viewData.parentIndex, null), null));
    final _anchor_1 = createViewContainerAnchor();
    _el_0.append(_anchor_1);
    _appEl_1 = ViewContainer(1, 0, this, _anchor_1);
    TemplateRef _TemplateRef_1_8 = TemplateRef(_appEl_1, viewFactory_MaterialTreeDropdownComponent1);
    _NgIf_1_9 = NgIf(_appEl_1, _TemplateRef_1_8);
    final _anchor_2 = createViewContainerAnchor();
    _el_0.append(_anchor_2);
    _appEl_2 = ViewContainer(2, 0, this, _anchor_2);
    TemplateRef _TemplateRef_2_8 = TemplateRef(_appEl_2, viewFactory_MaterialTreeDropdownComponent2);
    ...
    TemplateRef _TemplateRef_3_8 = TemplateRef(_appEl_3, viewFactory_MaterialTreeDropdownComponent3);
    _NgIf_3_9 = NgIf(_appEl_3, _TemplateRef_3_8);
    _compView_4 = import8.ViewMaterialPopupComponent0(this, 4);
    ...
    _MaterialPopupComponent_4_8 = (import15.isDevMode
        ? import17.debugInjectorWrap(import9.MaterialPopupComponent, () {
            return import9.MaterialPopupComponent(parentView.injectorGet(import23.PopupHierarchy, viewData.parentIndex, null), parentView.injectorGet(import9.MaterialPopupComponent, viewData.parentIndex, null), null, parentView.injectorGet(import24.NgZone, viewData.parentIndex), parentView.injectorGet(import25.OverlayService, viewData.parentIndex), parentView.injectorGet(import26.ZIndexer, viewData.parentIndex), parentView.injectorGet(const import27.OpaqueToken<List<import29.RelativePosition>>('defaultPopupPositions'), viewData.parentIndex), parentView.injectorGet(const import27.OpaqueToken<dynamic>('overlayRepositionLoop'), viewData.parentIndex), parentView.injectorGet(import30.PopupSizeProvider, viewData.parentIndex, null), _compView_4.ref, _appEl_4, ElementRef(_el_4));
          })
    ...
    TemplateRef _TemplateRef_6_8 = TemplateRef(_appEl_6, viewFactory_MaterialTreeDropdownComponent4);
    ...
    TemplateRef _TemplateRef_7_8 = TemplateRef(_appEl_7, viewFactory_MaterialTreeDropdownComponent5);
    _DeferredContentDirective_7_9 = import10.DeferredContentDirective(_appEl_7, _TemplateRef_7_8, _MaterialPopupComponent_4_8);
    _compView_4.create(_MaterialPopupComponent_4_8, [
      [_el_5],
      <dynamic>[projectableNodes[1]]..addAll([_appEl_7]),
      const []
    ]);
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((((identical(token, import9.MaterialPopupComponent) || identical(token, import32.DeferredContentAware)) || identical(token, import33.DropdownHandle)) && ((4 <= nodeIndex) && (nodeIndex <= 7)))) {
      return _MaterialPopupComponent_4_8;
    }
    if ((identical(token, import23.PopupHierarchy) && ((4 <= nodeIndex) && (nodeIndex <= 7)))) {
      return _PopupHierarchy_4_11;
    }
    if ((identical(token, import34.PopupRef) && ((4 <= nodeIndex) && (nodeIndex <= 7)))) {
  ...
  void detectChangesInternal() {
    ...
    if (!import14.AppViewUtils.throwOnChanges) {
      if (_query_MaterialTreeFilterComponent_1_0_isDirty) {
        ctx.materialTreeFilterComponent = import14.firstOrNull(import14.flattenNodes([
...
AppView<import2.MaterialTreeDropdownComponent> viewFactory_MaterialTreeDropdownComponent0(AppView<dynamic> parentView, int parentIndex) {
  return ViewMaterialTreeDropdownComponent0(parentView, parentIndex);
}
...
AppView<import2.MaterialTreeDropdownComponent> viewFactory_MaterialTreeDropdownComponent1(AppView<dynamic> parentView, int parentIndex) {
  return _ViewMaterialTreeDropdownComponent1(parentView, parentIndex);
}

class _ViewMaterialTreeDropdownComponent2 extends AppView<import2.MaterialTreeDropdownComponent> {
  import3.Element _el_0;
  import35.ViewMaterialIconComponent0 _compView_0;
  import36.MaterialIconComponent _MaterialIconComponent_0_5;
  ...
  @override
  ComponentRef<import2.MaterialTreeDropdownComponent> build() {
    _compView_0 = import35.ViewMaterialIconComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    _el_0.className = 'icon';
    createAttr(_el_0, 'icon', 'arrow_drop_down');
    addShimC(_el_0);
    _MaterialIconComponent_0_5 = import36.MaterialIconComponent(_el_0);
...
AppView<import2.MaterialTreeDropdownComponent> viewFactory_MaterialTreeDropdownComponent2(AppView<dynamic> parentView, int parentIndex) {
  return _ViewMaterialTreeDropdownComponent2(parentView, parentIndex);
}

class _ViewMaterialTreeDropdownComponent3 extends AppView<import2.MaterialTreeDropdownComponent> {
  import3.Element _el_0;
  import37.ViewMaterialTreeFilterComponent0 _compView_0;
  import38.MaterialTreeFilterComponent _MaterialTreeFilterComponent_0_5;
  String _expr_0;
  var _expr_1;
  ...
  @override
  ComponentRef<import2.MaterialTreeDropdownComponent> build() {
    _compView_0 = import37.ViewMaterialTreeFilterComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    addShimC(_el_0);
    _MaterialTreeFilterComponent_0_5 = (import15.isDevMode
        ? import17.debugInjectorWrap(import38.MaterialTreeFilterComponent, () {
            return import38.MaterialTreeFilterComponent(parentView.parentView.injectorGet(import39.MaterialTreeRoot, parentView.viewData.parentIndex, null));
          })
        : import38.MaterialTreeFilterComponent(parentView.parentView.injectorGet(import39.MaterialTreeRoot, parentView.viewData.parentIndex, null)));
  ...
  void dirtyParentQueriesInternal() {
    import15.unsafeCast<ViewMaterialTreeDropdownComponent0>(parentView)._query_MaterialTreeFilterComponent_1_0_isDirty = true;
  }
...
AppView<import2.MaterialTreeDropdownComponent> viewFactory_MaterialTreeDropdownComponent3(AppView<dynamic> parentView, int parentIndex) {
  return _ViewMaterialTreeDropdownComponent3(parentView, parentIndex);
}
...
AppView<import2.MaterialTreeDropdownComponent> viewFactory_MaterialTreeDropdownComponent4(AppView<dynamic> parentView, int parentIndex) {
  return _ViewMaterialTreeDropdownComponent4(parentView, parentIndex);
}

class _ViewMaterialTreeDropdownComponent5 extends AppView<import2.MaterialTreeDropdownComponent> {
  import3.Element _el_0;
  import40.ViewMaterialTreeComponent0 _compView_0;
  import41.MaterialTreeComponent _MaterialTreeComponent_0_5;
  bool _expr_0;
  var _expr_1;
  var _expr_2;
  var _expr_3;
  ...
  @override
  ComponentRef<import2.MaterialTreeDropdownComponent> build() {
    _compView_0 = import40.ViewMaterialTreeComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    addShimC(_el_0);
    _MaterialTreeComponent_0_5 = (import15.isDevMode
        ? import17.debugInjectorWrap(import41.MaterialTreeComponent, () {
            return import41.MaterialTreeComponent(parentView.parentView.injectorGet(import39.MaterialTreeRoot, parentView.viewData.parentIndex, null), null);
          })
        : import41.MaterialTreeComponent(parentView.parentView.injectorGet(import39.MaterialTreeRoot, parentView.viewData.parentIndex, null), null));
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import39.MaterialTreeRoot) && (0 == nodeIndex))) {
...
AppView<import2.MaterialTreeDropdownComponent> viewFactory_MaterialTreeDropdownComponent5(AppView<dynamic> parentView, int parentIndex) {
  return _ViewMaterialTreeDropdownComponent5(parentView, parentIndex);
}

final List<dynamic> styles$MaterialTreeDropdownComponentHost = const [];

class _ViewMaterialTreeDropdownComponentHost0 extends AppView<import2.MaterialTreeDropdownComponent> {
  ...
  ComponentRef<import2.MaterialTreeDropdownComponent> build() {
    ...
    _MaterialTreeDropdownComponent_0_5 = (import15.isDevMode
        ? import17.debugInjectorWrap(import2.MaterialTreeDropdownComponent, () {
            return import2.MaterialTreeDropdownComponent(this.injectorGet(import18.DomService, viewData.parentIndex));
          })
        : import2.MaterialTreeDropdownComponent(this.injectorGet(import18.DomService, viewData.parentIndex)));
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((((identical(token, import2.MaterialTreeDropdownComponent) || identical(token, import21.Focusable)) || identical(token, import39.MaterialTreeRoot)) && (0 == nodeIndex))) {
...
AppView<import2.MaterialTreeDropdownComponent> viewFactory_MaterialTreeDropdownComponentHost0(AppView<dynamic> parentView, int parentIndex) {

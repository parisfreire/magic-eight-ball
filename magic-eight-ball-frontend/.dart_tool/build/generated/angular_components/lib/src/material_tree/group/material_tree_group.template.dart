...
import '../../../material_checkbox/material_checkbox.template.dart' as import19;
import '../../../material_checkbox/material_checkbox.dart' as import20;
...
import 'package:angular/src/core/linker/dynamic_component_loader.dart' as import26;
import '../material_tree_root.dart' as import27;
import '../../../mixins/material_dropdown_base.dart' as import28;
import 'package:angular/src/core/di/opaque_token.dart' as import29;
import '../../../model/selection/selection_options.dart' as import30;
...
class ViewMaterialTreeGroupComponent0 extends AppView<import2.MaterialTreeGroupComponent> {
  ...
  ComponentRef<import2.MaterialTreeGroupComponent> build() {
    ...
    final _el_0 = createAndAppend(doc, 'ul', parentRenderNode);
    addShimC(_el_0);
...
class _ViewMaterialTreeGroupComponent1 extends AppView<import2.MaterialTreeGroupComponent> {
  ...
  bool _expr_8;
  var _expr_12;
  _ViewMaterialTreeGroupComponent1(AppView<dynamic> parentView, int parentIndex) : super(import7.ViewType.embedded, {'\$implicit': null}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
  ...
  ComponentRef<import2.MaterialTreeGroupComponent> build() {
    ...
    _KeyboardOnlyFocusIndicatorDirective_0_6 = (import11.isDevMode
        ? import17.debugInjectorWrap(import15.KeyboardOnlyFocusIndicatorDirective, () {
            return import15.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.injectorGet(import18.DomService, parentView.viewData.parentIndex));
          })
        : import15.KeyboardOnlyFocusIndicatorDirective(_el_0, parentView.parentView.injectorGet(import18.DomService, parentView.viewData.parentIndex)));
    ...
    final _text_8 = import9.Text(' ');
    _el_2.append(_text_8);
    final _text_9 = import9.Text(' ');
...
class _ViewMaterialTreeGroupComponent3 extends AppView<import2.MaterialTreeGroupComponent> {
  import9.Element _el_0;
  import19.ViewMaterialCheckboxComponent0 _compView_0;
  import20.MaterialCheckboxComponent _MaterialCheckboxComponent_0_5;
  bool _expr_0;
  bool _expr_2;
  ...
  @override
  ComponentRef<import2.MaterialTreeGroupComponent> build() {
    _compView_0 = import19.ViewMaterialCheckboxComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    _el_0.className = import10.interpolate2('', 'tree-selection-state', ' ', import20.MaterialCheckboxComponent.hostClass, '');
    addShimC(_el_0);
    _MaterialCheckboxComponent_0_5 = import20.MaterialCheckboxComponent(_el_0, _compView_0.ref, null, null, null);
...
class _ViewMaterialTreeGroupComponent5 extends AppView<import2.MaterialTreeGroupComponent> {
  ...
  import25.DynamicComponent _DynamicComponent_0_8;
  var _expr_0;
  var _expr_1;
  var _expr_2;
  ...
  @override
  ComponentRef<import2.MaterialTreeGroupComponent> build() {
    _compView_0 = import24.ViewDynamicComponent0(this, 0);
    _el_0 = _compView_0.rootEl;
    _el_0.className = 'item component';
    addShimC(_el_0);
    _appEl_0 = ViewContainer(0, null, this, _el_0);
    _DynamicComponent_0_8 = (import11.isDevMode
        ? import17.debugInjectorWrap(import25.DynamicComponent, () {
            return import25.DynamicComponent(parentView.parentView.parentView.injectorGet(import26.SlowComponentLoader, parentView.parentView.viewData.parentIndex), _compView_0.ref, _appEl_0);
          })
        : import25.DynamicComponent(parentView.parentView.parentView.injectorGet(import26.SlowComponentLoader, parentView.parentView.viewData.parentIndex), _compView_0.ref, _appEl_0));
...
class _ViewMaterialTreeGroupComponent7 extends AppView<import2.MaterialTreeGroupComponent> {
  ...
  import22.ViewMaterialIconComponent0 _compView_0;
  import14.ButtonDirectiveNgCd _ButtonDirective_0_5;
  import23.MaterialIconComponent _MaterialIconComponent_0_6;
  bool _expr_0;
  var _expr_1;
  ...
  ComponentRef<import2.MaterialTreeGroupComponent> build() {
    ...
    addShimC(_el_0);
    _ButtonDirective_0_5 = import14.ButtonDirectiveNgCd(import16.ButtonDirective(_el_0, null));
    _MaterialIconComponent_0_6 = import23.MaterialIconComponent(_el_0);
...
class _ViewMaterialTreeGroupComponent8 extends AppView<import2.MaterialTreeGroupComponent> {
  ...
  int _expr_4;
  bool _expr_5;
  _ViewMaterialTreeGroupComponent8(AppView<dynamic> parentView, int parentIndex) : super(import7.ViewType.embedded, {'\$implicit': null}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
    componentType = ViewMaterialTreeGroupComponent0._renderType;
  }
  @override
  ComponentRef<import2.MaterialTreeGroupComponent> build() {
    ...
    _MaterialTreeGroupComponent_0_5 = (import11.isDevMode
        ? import17.debugInjectorWrap(import2.MaterialTreeGroupComponent, () {
            return import2.MaterialTreeGroupComponent(parentView.parentView.parentView.injectorGet(import27.MaterialTreeRoot, parentView.parentView.viewData.parentIndex), _compView_0.ref, parentView.parentView.parentView.injectorGet(import28.DropdownHandle, parentView.parentView.viewData.parentIndex, null), parentView.parentView.parentView.injectorGet(const import29.OpaqueToken<dynamic>('MaterialTreeGroupComponent_materialTreeLeftPaddingToken'), parentView.parentView.viewData.parentIndex, null));
          })
        : import2.MaterialTreeGroupComponent(parentView.parentView.parentView.injectorGet(import27.MaterialTreeRoot, parentView.parentView.viewData.parentIndex), _compView_0.ref, parentView.parentView.parentView.injectorGet(import28.DropdownHandle, parentView.parentView.viewData.parentIndex, null), parentView.parentView.parentView.injectorGet(const import29.OpaqueToken<dynamic>('MaterialTreeGroupComponent_materialTreeLeftPaddingToken'), parentView.parentView.viewData.parentIndex, null)));
  ...
  void detectChangesInternal() {
    final _ctx = ctx;
    bool firstCheck = (this.cdState == 0);
    final local_subGroup = import11.unsafeCast<import30.OptionGroup<dynamic>>(locals['\$implicit']);
    final local_option = parentView.locals['\$implicit'];
...
class _ViewMaterialTreeGroupComponent9 extends AppView<import2.MaterialTreeGroupComponent> {
  ...
  ComponentRef<import2.MaterialTreeGroupComponent> build() {
    ...
    _text_4 = import9.Text((import2.MaterialTreeGroupComponent.viewMoreMsg ?? ''));
...
class _ViewMaterialTreeGroupComponentHost0 extends AppView<import2.MaterialTreeGroupComponent> {
  ...
  ComponentRef<import2.MaterialTreeGroupComponent> build() {
    ...
    _MaterialTreeGroupComponent_0_5 = (import11.isDevMode
        ? import17.debugInjectorWrap(import2.MaterialTreeGroupComponent, () {
            return import2.MaterialTreeGroupComponent(this.injectorGet(import27.MaterialTreeRoot, viewData.parentIndex), _compView_0.ref, this.injectorGet(import28.DropdownHandle, viewData.parentIndex, null), this.injectorGet(const import29.OpaqueToken<dynamic>('MaterialTreeGroupComponent_materialTreeLeftPaddingToken'), viewData.parentIndex, null));
          })
        : import2.MaterialTreeGroupComponent(this.injectorGet(import27.MaterialTreeRoot, viewData.parentIndex), _compView_0.ref, this.injectorGet(import28.DropdownHandle, viewData.parentIndex, null), this.injectorGet(const import29.OpaqueToken<dynamic>('MaterialTreeGroupComponent_materialTreeLeftPaddingToken'), viewData.parentIndex, null)));

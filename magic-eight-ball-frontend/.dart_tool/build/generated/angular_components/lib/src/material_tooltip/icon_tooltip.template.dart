...
class ViewMaterialIconTooltipComponent0 extends AppView<import2.MaterialIconTooltipComponent> {
  ...
  ComponentRef<import2.MaterialIconTooltipComponent> build() {
    ...
    _ClickableTooltipTargetDirective_1_8 = (import15.isDevMode
        ? import17.debugInjectorWrap(import6.ClickableTooltipTargetDirective, () {
            return import6.ClickableTooltipTargetDirective(parentView.injectorGet(import18.DomPopupSourceFactory, viewData.parentIndex), _appEl_1, _el_1, _compView_1.ref);
          })
        : import6.ClickableTooltipTargetDirective(parentView.injectorGet(import18.DomPopupSourceFactory, viewData.parentIndex), _appEl_1, _el_1, _compView_1.ref));
    ...
    _KeyboardOnlyFocusIndicatorDirective_1_10 = (import15.isDevMode
        ? import17.debugInjectorWrap(import8.KeyboardOnlyFocusIndicatorDirective, () {
            return import8.KeyboardOnlyFocusIndicatorDirective(_el_1, parentView.injectorGet(import19.DomService, viewData.parentIndex));
          })
        : import8.KeyboardOnlyFocusIndicatorDirective(_el_1, parentView.injectorGet(import19.DomService, viewData.parentIndex)));
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    ...
    if (((identical(token, import10.MaterialPaperTooltipComponent) || identical(token, import23.DeferredContentAware)) && ((4 <= nodeIndex) && (nodeIndex <= 6)))) {

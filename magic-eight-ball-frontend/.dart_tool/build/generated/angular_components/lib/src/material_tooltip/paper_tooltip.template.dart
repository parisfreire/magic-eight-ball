...
class _ViewMaterialPaperTooltipComponent1 extends AppView<import2.MaterialPaperTooltipComponent> {
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((((identical(token, import14.MaterialPopupComponent) || identical(token, import25.DeferredContentAware)) || identical(token, import26.DropdownHandle)) && ((0 <= nodeIndex) && (nodeIndex <= 10)))) {
      return _MaterialPopupComponent_0_8;
    }
    if ((identical(token, import16.PopupHierarchy) && ((0 <= nodeIndex) && (nodeIndex <= 10)))) {
      return _PopupHierarchy_0_11;
    }
    if ((identical(token, import27.PopupRef) && ((0 <= nodeIndex) && (nodeIndex <= 10)))) {
...
class _ViewMaterialPaperTooltipComponentHost0 extends AppView<import2.MaterialPaperTooltipComponent> {
  ...
  ComponentRef<import2.MaterialPaperTooltipComponent> build() {
    ...
    _TooltipController_0_5 = (import10.isDevMode
        ? import15.debugInjectorWrap(import28.TooltipController, () {
            return import29.createTooltipController(this.injectorGet(import28.TooltipController, viewData.parentIndex, null), this.injectorGet(import30.Disposer, viewData.parentIndex, null));
          })
        : import29.createTooltipController(this.injectorGet(import28.TooltipController, viewData.parentIndex, null), this.injectorGet(import30.Disposer, viewData.parentIndex, null)));
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    ...
    if (((identical(token, import2.MaterialPaperTooltipComponent) || identical(token, import25.DeferredContentAware)) && (0 == nodeIndex))) {

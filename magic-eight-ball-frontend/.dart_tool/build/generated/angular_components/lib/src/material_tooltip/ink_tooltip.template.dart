...
import '../laminate/popup/popup_ref.dart' as import28;
...
class _ViewMaterialInkTooltipComponent1 extends AppView<import2.MaterialInkTooltipComponent> {
  ...
  ComponentRef<import2.MaterialInkTooltipComponent> build() {
    ...
    _MaterialPopupComponent_0_8 = (import10.isDevMode
        ? import16.debugInjectorWrap(import14.MaterialPopupComponent, () {
            return import14.MaterialPopupComponent(parentView.injectorGet(import17.PopupHierarchy, viewData.parentIndex, null), parentView.injectorGet(import14.MaterialPopupComponent, viewData.parentIndex, null), 'tooltip', parentView.injectorGet(import18.NgZone, viewData.parentIndex), parentView.injectorGet(import19.OverlayService, viewData.parentIndex), parentView.injectorGet(import20.ZIndexer, viewData.parentIndex), parentView.injectorGet(const import21.OpaqueToken<List<import23.RelativePosition>>('defaultPopupPositions'), viewData.parentIndex), parentView.injectorGet(const import21.OpaqueToken<dynamic>('overlayRepositionLoop'), viewData.parentIndex), parentView.injectorGet(import24.PopupSizeProvider, viewData.parentIndex, null), _compView_0.ref, _appEl_0, ElementRef(_el_0));
          })
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((((identical(token, import14.MaterialPopupComponent) || identical(token, import26.DeferredContentAware)) || identical(token, import27.DropdownHandle)) && ((0 <= nodeIndex) && (nodeIndex <= 3)))) {
    ...
    if ((identical(token, import28.PopupRef) && ((0 <= nodeIndex) && (nodeIndex <= 3)))) {
...
class _ViewMaterialInkTooltipComponentHost0 extends AppView<import2.MaterialInkTooltipComponent> {
  ...
  ComponentRef<import2.MaterialInkTooltipComponent> build() {
    ...
    _TooltipController_0_5 = (import10.isDevMode
        ? import16.debugInjectorWrap(import29.TooltipController, () {
            return import30.createTooltipController(this.injectorGet(import29.TooltipController, viewData.parentIndex, null), this.injectorGet(import31.Disposer, viewData.parentIndex, null));
          })
        : import30.createTooltipController(this.injectorGet(import29.TooltipController, viewData.parentIndex, null), this.injectorGet(import31.Disposer, viewData.parentIndex, null)));

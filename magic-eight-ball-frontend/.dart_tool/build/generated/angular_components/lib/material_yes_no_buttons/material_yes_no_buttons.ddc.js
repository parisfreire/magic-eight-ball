define(['dart_sdk', 'packages/angular_components/interfaces/has_disabled', 'packages/angular_components/material_button/material_button', 'packages/intl/intl', 'packages/angular/src/core/change_detection/change_detection'], function(dart_sdk, has_disabled, material_button, intl, change_detection) {
  'use strict';
  ...
  const noDisabled = Symbol("MaterialYesNoButtonsComponent.noDisabled");
  ...
  material_yes_no_buttons__material_yes_no_buttons.MaterialYesNoButtonsComponent[dart.implements] = () => [interfaces__has_disabled.HasDisabled];
  ...
  dart.setFieldSignature(material_yes_no_buttons__material_yes_no_buttons.MaterialYesNoButtonsComponent, () => ({
    ...
    noDisabled: dart.fieldType(core.bool),
  ...
  dart.defineLazy(material_yes_no_buttons__material_yes_no_buttons.MaterialYesNoButtonsComponent, {
    /*material_yes_no_buttons__material_yes_no_buttons.MaterialYesNoButtonsComponent._msgYes*/get _msgYes() {
      return intl$.Intl.message("Yes", {name: "_msgYes", desc: "Text on yes button.", meaning: "Text on yes button."});
    },
    /*material_yes_no_buttons__material_yes_no_buttons.MaterialYesNoButtonsComponent._msgNo*/get _msgNo() {
  ...
  dart.defineLazy(material_yes_no_buttons__material_yes_no_buttons.MaterialSaveCancelButtonsDirective, {
    ...
    /*material_yes_no_buttons__material_yes_no_buttons.MaterialSaveCancelButtonsDirective._msgCancel*/get _msgCancel() {

define(['dart_sdk', 'packages/angular_components/utils/disposer/disposer'], function(dart_sdk, disposer) {
  ...
  model__observable__observable.ChangeNotificationProvider$ = dart.generic(T => {
    ...
    dart.setGetterSignature(ChangeNotificationProvider, () => ({
      ...
      changes: async.Stream$(model__observable__observable.Change$(T)),
      [_hasStreamListener]: core.bool,
      [_hasChangeListener]: core.bool,
      [_isActive]: core.bool,
  ...
  model__observable__observable.ObservableViewMixin$ = dart.generic(T => {
    ...
    class ObservableViewMixin extends core.Object {
      ...
      get firstNonNull() {
        return this.value != null ? FutureOfT().value(this.value) : this.stream.firstWhere(dart.fn(value => value != null, TTobool()));
      }
      get values() {
        let controller = null;
        controller = StreamControllerOfT().new({onListen: dart.fn(() => {
            controller.add(this.value);
            controller.addStream(this.stream).then(dart.dynamic, dart.fn(_ => controller.close(), dynamicToFuture()));
          }, VoidToNull())});
        return controller.stream;
      }
      get nonNullValues() {
        return this.values.where(dart.fn(value => value != null, TTobool()));
      }
      map(M, mapper) {
  ...
  model__observable__observable.ObservableReference$ = dart.generic(T => {
    ...
    dart.applyMixin(ChangeNotificationProvider_ObservableViewMixin$, model__observable__observable.ObservableViewMixin$(T));
    ...
    (ObservableReference.new = function(value, opts) {
      let equalsFn = opts && 'equalsFn' in opts ? opts.equalsFn : dart.fn(model__observable__observable.ObservableReference._defaultEq, dynamicAnddynamicTobool());

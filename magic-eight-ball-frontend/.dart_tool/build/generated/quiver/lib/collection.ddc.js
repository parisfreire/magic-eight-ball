define(['dart_sdk', 'packages/quiver/core', 'packages/quiver/iterables'], function(dart_sdk, core, iterables) {
  ...
  collection$.LinkedLruHashMap$ = dart.generic((K, V) => {
    ...
    class LinkedLruHashMap extends core$.Object {
      ...
      get entries() {
        return this[_entries][$values][$map](MapEntryOfK$V(), dart.fn(entry => MapEntryOfK$V().new(entry.key, entry.value), _LinkedEntryOfK$VToMapEntryOfK$V()));
      }
      forEach(action) {
        let head = this[_head];
        while (head != null) {

...
import 'package:angular/src/core/testability/testability.dart' as _i3;
import 'package:angular/src/bootstrap/modules.dart' as _i4;
import 'package:angular/src/core/linker/component_loader.dart' as _i5;
import 'package:angular/src/security/dom_sanitization_service_impl.dart' as _i6;
import 'package:angular/src/platform/browser/exceptions.dart' as _i7;
...
import 'package:angular/src/security/dom_sanitization_service.dart' as _i10;
import 'package:angular/src/core/di/opaque_token.dart' as _i11;
import 'package:angular/src/core/linker/dynamic_component_loader.dart' as _i12;
...
class _Injector$minimalApp extends _i2.HierarchicalInjector {
  ...
  _i3.Testability _field0;

  _i4.ThrowingSlowComponentLoader _field1;

  _i5.ComponentLoader _field2;

  dynamic _field3;

  dynamic _field4;

  _i6.DomSanitizationServiceImpl _field5;

  _i7.BrowserExceptionHandler _field7;

  dynamic _field8;

  _i8.EventManager _field9;

  _i3.Testability _getTestability$0() => _field0 ??= new _i3.Testability(inject(_i9.NgZone));
  _i4.ThrowingSlowComponentLoader _getThrowingSlowComponentLoader$1() => _field1 ??= new _i4.ThrowingSlowComponentLoader();
  _i5.ComponentLoader _getComponentLoader$2() => _field2 ??= new _i5.ComponentLoader();
  dynamic _getdynamic$3() => _field3 ??= _i4.createRandomAppId();
  dynamic _getdynamic$4() => _field4 ??= _i4.createNgZone();
  _i6.DomSanitizationServiceImpl _getDomSanitizationServiceImpl$5() => _field5 ??= new _i6.DomSanitizationServiceImpl();
  dynamic _getExisting$6() => inject(_i10.DomSanitizationService);
  _i7.BrowserExceptionHandler _getBrowserExceptionHandler$7() => _field7 ??= new _i7.BrowserExceptionHandler();
  dynamic _getdynamic$8() => _field8 ??= _i4.createEventPlugins();
  _i8.EventManager _getEventManager$9() => _field9 ??= new _i8.EventManager(inject(const _i11.OpaqueToken<dynamic>('EventManagerPlugins')), inject(_i9.NgZone));
  _i1.Injector _getInjector$10() => this;
  @override
  Object injectFromSelfOptional(Object token, [Object orElse = _i1.throwIfNotFound]) {
    if (identical(token, _i3.Testability)) {
      return _getTestability$0();
    }
    if (identical(token, _i12.SlowComponentLoader)) {
      return _getThrowingSlowComponentLoader$1();
    }
    if (identical(token, _i5.ComponentLoader)) {
      return _getComponentLoader$2();
    }
    ...
    if (identical(token, _i10.DomSanitizationService)) {
      return _getDomSanitizationServiceImpl$5();
    }
    if (identical(token, _i13.SanitizationService)) {
      return _getExisting$6();
    }
    if (identical(token, _i14.ExceptionHandler)) {
      return _getBrowserExceptionHandler$7();
    }

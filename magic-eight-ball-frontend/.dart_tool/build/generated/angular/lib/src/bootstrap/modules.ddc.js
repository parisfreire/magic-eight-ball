define(['dart_sdk', 'packages/angular/src/core/change_detection/change_detection', 'packages/angular/src/core/zone/ng_zone', 'packages/angular/src/core/application_tokens', 'packages/angular/src/core/linker/view_type', 'packages/angular/src/core/change_detection/change_detection.template', 'packages/angular/di.template', 'packages/angular/src/core/application_tokens.template', 'packages/angular/core.template', 'packages/intl/intl'], function(dart_sdk, change_detection, ng_zone, application_tokens, view_type, change_detection$, di, application_tokens$, core, intl) {
  ...
  const _getTestability$0 = Symbol('_getTestability$0');
  const _getThrowingSlowComponentLoader$1 = Symbol('_getThrowingSlowComponentLoader$1');
  const _getComponentLoader$2 = Symbol('_getComponentLoader$2');
  const _getdynamic$3 = Symbol('_getdynamic$3');
  const _getdynamic$4 = Symbol('_getdynamic$4');
  const _getDomSanitizationServiceImpl$5 = Symbol('_getDomSanitizationServiceImpl$5');
  const _getExisting$6 = Symbol('_getExisting$6');
  const _getBrowserExceptionHandler$7 = Symbol('_getBrowserExceptionHandler$7');
  ...
  src__bootstrap__modules$46template._Injector$minimalApp = class _Injector$minimalApp extends src__di__injector__hierarchical.HierarchicalInjector {
    [_getTestability$0]() {
      let t = this[_field0];
      return t == null ? this[_field0] = new src__core__testability__testability.Testability.new(this.inject(src__core__zone__ng_zone.NgZone, dart.wrapType(src__core__zone__ng_zone.NgZone))) : t;
    }
    [_getThrowingSlowComponentLoader$1]() {
      let t = this[_field1];
      return t == null ? this[_field1] = new src__bootstrap__modules.ThrowingSlowComponentLoader.new() : t;
    }
    [_getComponentLoader$2]() {
      let t = this[_field2];
      return t == null ? this[_field2] = new src__core__linker__component_loader.ComponentLoader.new() : t;
    }
    [_getdynamic$3]() {
      let t = this[_field3];
      return t == null ? this[_field3] = src__bootstrap__modules.createRandomAppId() : t;
    }
    [_getdynamic$4]() {
      let t = this[_field4];
      return t == null ? this[_field4] = src__bootstrap__modules.createNgZone() : t;
    }
    [_getDomSanitizationServiceImpl$5]() {
      let t = this[_field5];
      return t == null ? this[_field5] = src__security__dom_sanitization_service_impl.DomSanitizationServiceImpl.new() : t;
    }
    [_getExisting$6]() {
      return this.inject(dart.dynamic, dart.wrapType(src__security__dom_sanitization_service.DomSanitizationService));
    }
    [_getBrowserExceptionHandler$7]() {
      let t = this[_field7];
      return t == null ? this[_field7] = new src__platform__browser__exceptions.BrowserExceptionHandler.new() : t;
    }
    [_getdynamic$8]() {
      let t = this[_field8];
      return t == null ? this[_field8] = src__bootstrap__modules.createEventPlugins() : t;
    }
    [_getEventManager$9]() {
      let t = this[_field9];
  ...
  dart.setMethodSignature(src__bootstrap__modules$46template._Injector$minimalApp, () => ({
    ...
    [_getTestability$0]: dart.fnType(src__core__testability__testability.Testability, []),
    [_getThrowingSlowComponentLoader$1]: dart.fnType(src__bootstrap__modules.ThrowingSlowComponentLoader, []),
    [_getComponentLoader$2]: dart.fnType(src__core__linker__component_loader.ComponentLoader, []),
    [_getdynamic$3]: dart.fnType(dart.dynamic, []),
    [_getdynamic$4]: dart.fnType(dart.dynamic, []),
    [_getDomSanitizationServiceImpl$5]: dart.fnType(src__security__dom_sanitization_service_impl.DomSanitizationServiceImpl, []),
    [_getExisting$6]: dart.fnType(dart.dynamic, []),
    [_getBrowserExceptionHandler$7]: dart.fnType(src__platform__browser__exceptions.BrowserExceptionHandler, []),
  ...
  dart.setFieldSignature(src__bootstrap__modules$46template._Injector$minimalApp, () => ({
    ...
    [_field0]: dart.fieldType(src__core__testability__testability.Testability),
    [_field1]: dart.fieldType(src__bootstrap__modules.ThrowingSlowComponentLoader),
    [_field2]: dart.fieldType(src__core__linker__component_loader.ComponentLoader),
    [_field3]: dart.fieldType(dart.dynamic),
    [_field4]: dart.fieldType(dart.dynamic),
    [_field5]: dart.fieldType(src__security__dom_sanitization_service_impl.DomSanitizationServiceImpl),
    [_field7]: dart.fieldType(src__platform__browser__exceptions.BrowserExceptionHandler),
    [_field8]: dart.fieldType(dart.dynamic),

define(['dart_sdk', 'packages/collection/src/canonicalized_map'], function(dart_sdk, canonicalized_map) {
  ...
  src__util__iterable_set.IterableSet$ = dart.generic(E => {
    ...
    dart.applyMixin(SetMixin_UnmodifiableSetMixin$, src__unmodifiable_wrappers.UnmodifiableSetMixin$(E));
  ...
  dart.trackLibraries("packages/test_api/src/util/iterable_set.ddc", {
    "package:test_api/src/util/iterable_set.dart": src__util__iterable_set
  }, '{"version":3,"sourceRoot":"","sources":["iterable_set.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;cAqBoB,YAAK,SAAO;;;cAEF,YAAK,WAAS;;eAK5B,OAAc;cAAK,YAAK,WAAS,CAAC,OAAO;MAAC;aAE/C,MAAa;cAClB,YAAK,aAAW,CAAC,QAAC,OAAO,gBAAK,OAAO,EAAI,MAAM,wBAAU,cAAM;MAAK;;cAEtD,YAAK,QAAM;MAAE;;;MAPd,WAAK;IAAC","file":"iterable_set.ddc.js"}');
  // Exports:
  return {
